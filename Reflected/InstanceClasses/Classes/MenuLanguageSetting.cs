...
/// </summary>
public class MenuLanguageSettingR : InstanceClassWrapper<MenuLanguageSetting>
{
    public MenuLanguageSettingR(MenuLanguageSetting _orig) : base(_orig)
    {
    }

    public SupportedLanguages[] langs
    {
        get => GetField<SupportedLanguages[]>();
        set => SetField(value);
    }
    ...
    {
        return MenuLanguageSetting.RectTransformToScreenSpace(transform);
    }
