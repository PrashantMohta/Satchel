...
/// <summary>
///     A class that contains all (public and private) fields and methods of RazerSabertoothEliteControllerMacNativeProfile
///     allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class
    RazerSabertoothEliteControllerMacNativeProfileR : InstanceClassWrapper<
        RazerSabertoothEliteControllerMacNativeProfile>
{
    public RazerSabertoothEliteControllerMacNativeProfileR(RazerSabertoothEliteControllerMacNativeProfile _orig) :
        base(_orig)
    {
    }
