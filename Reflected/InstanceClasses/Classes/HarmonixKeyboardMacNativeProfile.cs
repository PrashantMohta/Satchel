...
/// <summary>
///     A class that contains all (public and private) fields and methods of HarmonixKeyboardMacNativeProfile allowing you
///     to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class HarmonixKeyboardMacNativeProfileR : InstanceClassWrapper<HarmonixKeyboardMacNativeProfile>
{
    public HarmonixKeyboardMacNativeProfileR(HarmonixKeyboardMacNativeProfile _orig) : base(_orig)
    {
    }
