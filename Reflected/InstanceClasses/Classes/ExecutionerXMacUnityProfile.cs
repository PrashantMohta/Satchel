...
/// </summary>
public class ExecutionerXMacUnityProfileR : InstanceClassWrapper<ExecutionerXMacUnityProfile>
{
    public ExecutionerXMacUnityProfileR(ExecutionerXMacUnityProfile _orig) : base(_orig)
    {
    }
