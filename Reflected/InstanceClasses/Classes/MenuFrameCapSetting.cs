...
/// </summary>
public class MenuFrameCapSettingR : InstanceClassWrapper<MenuFrameCapSetting>
{
    public MenuFrameCapSettingR(MenuFrameCapSetting _orig) : base(_orig)
    {
    }

    public int[] frameCapValues
    {
        get => GetField<int[]>();
        set => SetField(value);
    }
