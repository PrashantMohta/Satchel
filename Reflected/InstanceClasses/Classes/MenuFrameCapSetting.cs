...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of MenuFrameCapSetting allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class MenuFrameCapSettingR:InstanceClassWrapper<UnityEngine.UI.MenuFrameCapSetting>
{
public MenuFrameCapSettingR(UnityEngine.UI.MenuFrameCapSetting _orig) : base(_orig) {}
public System.Int32[] frameCapValues
{
...
orig.ApplyValueFromGameSettings();

public void UpdateFrameCapSetting () =>
CallMethod();
