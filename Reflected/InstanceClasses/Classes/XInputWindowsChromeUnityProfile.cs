...
/// <summary>
///     A class that contains all (public and private) fields and methods of XInputWindowsChromeUnityProfile allowing you
///     to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class XInputWindowsChromeUnityProfileR : InstanceClassWrapper<XInputWindowsChromeUnityProfile>
{
    public XInputWindowsChromeUnityProfileR(XInputWindowsChromeUnityProfile _orig) : base(_orig)
    {
    }
