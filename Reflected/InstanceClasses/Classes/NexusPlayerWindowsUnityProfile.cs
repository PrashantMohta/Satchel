...
/// </summary>
public class NexusPlayerWindowsUnityProfileR : InstanceClassWrapper<NexusPlayerWindowsUnityProfile>
{
    public NexusPlayerWindowsUnityProfileR(NexusPlayerWindowsUnityProfile _orig) : base(_orig)
    {
    }
