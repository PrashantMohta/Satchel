...
/// </summary>
public class XboxOneMacUnityProfileR : InstanceClassWrapper<XboxOneMacUnityProfile>
{
    public XboxOneMacUnityProfileR(XboxOneMacUnityProfile _orig) : base(_orig)
    {
    }
