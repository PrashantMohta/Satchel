...
/// </summary>
public class RazerServalForgeTVUnityProfileR : InstanceClassWrapper<RazerServalForgeTVUnityProfile>
{
    public RazerServalForgeTVUnityProfileR(RazerServalForgeTVUnityProfile _orig) : base(_orig)
    {
    }
