...
/// </summary>
public class QuaternionRotateTowardsR : InstanceClassWrapper<QuaternionRotateTowards>
{
    public QuaternionRotateTowardsR(QuaternionRotateTowards _orig) : base(_orig)
    {
    }
