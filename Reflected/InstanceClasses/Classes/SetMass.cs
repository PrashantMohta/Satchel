...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of SetMass allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class SetMassR:InstanceClassWrapper<HutongGames.PlayMaker.Actions.SetMass>
{
public SetMassR(HutongGames.PlayMaker.Actions.SetMass _orig) : base(_orig) {}
