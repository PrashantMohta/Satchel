...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of ArrayListGetFarthestGameObjectInSight allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class ArrayListGetFarthestGameObjectInSightR:InstanceClassWrapper<HutongGames.PlayMaker.Actions.ArrayListGetFarthestGameObjectInSight>
{
public ArrayListGetFarthestGameObjectInSightR(HutongGames.PlayMaker.Actions.ArrayListGetFarthestGameObjectInSight _orig) : base(_orig) {}
