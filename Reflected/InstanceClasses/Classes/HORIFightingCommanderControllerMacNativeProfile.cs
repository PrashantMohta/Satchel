...
///     HORIFightingCommanderControllerMacNativeProfile allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class
    HORIFightingCommanderControllerMacNativeProfileR : InstanceClassWrapper<
        HORIFightingCommanderControllerMacNativeProfile>
{
    public HORIFightingCommanderControllerMacNativeProfileR(HORIFightingCommanderControllerMacNativeProfile _orig) :
        base(_orig)
    {
    }
