...
/// </summary>
public class XboxOneMacChromeUnityProfileR : InstanceClassWrapper<XboxOneMacChromeUnityProfile>
{
    public XboxOneMacChromeUnityProfileR(XboxOneMacChromeUnityProfile _orig) : base(_orig)
    {
    }
