...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of XboxOneMacChromeUnityProfile allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class XboxOneMacChromeUnityProfileR:InstanceClassWrapper<InControl.UnityDeviceProfiles.XboxOneMacChromeUnityProfile>
{
public XboxOneMacChromeUnityProfileR(InControl.UnityDeviceProfiles.XboxOneMacChromeUnityProfile _orig) : base(_orig) {}
