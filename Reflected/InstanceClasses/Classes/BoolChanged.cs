...
/// </summary>
public class BoolChangedR:InstanceClassWrapper<HutongGames.PlayMaker.Actions.BoolChanged>
{
public BoolChangedR(HutongGames.PlayMaker.Actions.BoolChanged _orig) : base(_orig) {}
