...
/// </summary>
public class IonDrumRockerMacNativeProfileR : InstanceClassWrapper<IonDrumRockerMacNativeProfile>
{
    public IonDrumRockerMacNativeProfileR(IonDrumRockerMacNativeProfile _orig) : base(_orig)
    {
    }
