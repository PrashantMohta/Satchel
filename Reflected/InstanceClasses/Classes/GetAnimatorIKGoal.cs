...
/// </summary>
public class GetAnimatorIKGoalR : InstanceClassWrapper<GetAnimatorIKGoal>
{
    public GetAnimatorIKGoalR(GetAnimatorIKGoal _orig) : base(_orig)
    {
    }
    ...
    public AvatarIKGoal _iKGoal
    {
        get => GetField<AvatarIKGoal>();
        set => SetField(value);
    }
