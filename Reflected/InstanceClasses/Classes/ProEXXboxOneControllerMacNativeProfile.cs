...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of ProEXXboxOneControllerMacNativeProfile allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class ProEXXboxOneControllerMacNativeProfileR:InstanceClassWrapper<InControl.NativeDeviceProfiles.ProEXXboxOneControllerMacNativeProfile>
{
public ProEXXboxOneControllerMacNativeProfileR(InControl.NativeDeviceProfiles.ProEXXboxOneControllerMacNativeProfile _orig) : base(_orig) {}
