...
/// </summary>
public class MogaProMacUnityProfileR : InstanceClassWrapper<MogaProMacUnityProfile>
{
    public MogaProMacUnityProfileR(MogaProMacUnityProfile _orig) : base(_orig)
    {
    }
