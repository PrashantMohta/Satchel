...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of SetAudioPitch allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class SetAudioPitchR:InstanceClassWrapper<HutongGames.PlayMaker.Actions.SetAudioPitch>
{
public SetAudioPitchR(HutongGames.PlayMaker.Actions.SetAudioPitch _orig) : base(_orig) {}
...
public HutongGames.PlayMaker.FsmFloat pitch
{
get => orig.pitch;
set => orig.pitch = value;
}
