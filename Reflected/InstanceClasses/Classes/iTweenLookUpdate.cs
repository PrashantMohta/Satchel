...
/// </summary>
public class iTweenLookUpdateR:InstanceClassWrapper<HutongGames.PlayMaker.Actions.iTweenLookUpdate>
{
public iTweenLookUpdateR(HutongGames.PlayMaker.Actions.iTweenLookUpdate _orig) : base(_orig) {}
