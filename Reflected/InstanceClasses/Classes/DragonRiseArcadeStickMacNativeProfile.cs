...
/// <summary>
///     A class that contains all (public and private) fields and methods of DragonRiseArcadeStickMacNativeProfile allowing
///     you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class DragonRiseArcadeStickMacNativeProfileR : InstanceClassWrapper<DragonRiseArcadeStickMacNativeProfile>
{
    public DragonRiseArcadeStickMacNativeProfileR(DragonRiseArcadeStickMacNativeProfile _orig) : base(_orig)
    {
    }
