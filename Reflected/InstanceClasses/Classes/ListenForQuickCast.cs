...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of ListenForQuickCast allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class ListenForQuickCastR:InstanceClassWrapper<HutongGames.PlayMaker.Actions.ListenForQuickCast>
{
public ListenForQuickCastR(HutongGames.PlayMaker.Actions.ListenForQuickCast _orig) : base(_orig) {}
