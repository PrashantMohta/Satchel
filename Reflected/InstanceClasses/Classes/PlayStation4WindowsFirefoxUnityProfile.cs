...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of PlayStation4WindowsFirefoxUnityProfile allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class PlayStation4WindowsFirefoxUnityProfileR:InstanceClassWrapper<InControl.UnityDeviceProfiles.PlayStation4WindowsFirefoxUnityProfile>
{
public PlayStation4WindowsFirefoxUnityProfileR(InControl.UnityDeviceProfiles.PlayStation4WindowsFirefoxUnityProfile _orig) : base(_orig) {}
