...
/// <summary>
///     A class that contains all (public and private) fields and methods of MicrosoftXboxOneControllerMacNativeProfile
///     allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class
    MicrosoftXboxOneControllerMacNativeProfileR : InstanceClassWrapper<MicrosoftXboxOneControllerMacNativeProfile>
{
    public MicrosoftXboxOneControllerMacNativeProfileR(MicrosoftXboxOneControllerMacNativeProfile _orig) : base(_orig)
    {
    }
