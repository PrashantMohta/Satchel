...
/// <summary>
///     A class that contains all (public and private) fields and methods of MadCatzMicroConControllerMacNativeProfile
///     allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class
    MadCatzMicroConControllerMacNativeProfileR : InstanceClassWrapper<MadCatzMicroConControllerMacNativeProfile>
{
    public MadCatzMicroConControllerMacNativeProfileR(MadCatzMicroConControllerMacNativeProfile _orig) : base(_orig)
    {
    }
