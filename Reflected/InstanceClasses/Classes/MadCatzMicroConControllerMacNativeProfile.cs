...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of MadCatzMicroConControllerMacNativeProfile allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class MadCatzMicroConControllerMacNativeProfileR:InstanceClassWrapper<InControl.NativeDeviceProfiles.MadCatzMicroConControllerMacNativeProfile>
{
public MadCatzMicroConControllerMacNativeProfileR(InControl.NativeDeviceProfiles.MadCatzMicroConControllerMacNativeProfile _orig) : base(_orig) {}
