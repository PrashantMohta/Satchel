...
/// </summary>
public class GoogleStadiaMacUnityProfileR : InstanceClassWrapper<GoogleStadiaMacUnityProfile>
{
    public GoogleStadiaMacUnityProfileR(GoogleStadiaMacUnityProfile _orig) : base(_orig)
    {
    }
