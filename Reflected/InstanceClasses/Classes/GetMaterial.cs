...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of GetMaterial allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class GetMaterialR:InstanceClassWrapper<HutongGames.PlayMaker.Actions.GetMaterial>
{
public GetMaterialR(HutongGames.PlayMaker.Actions.GetMaterial _orig) : base(_orig) {}
...
{
get => orig.getSharedMaterial;
set => orig.getSharedMaterial = value;
}
