...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of InjusticeFightStickMacNativeProfile allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class InjusticeFightStickMacNativeProfileR:InstanceClassWrapper<InControl.NativeDeviceProfiles.InjusticeFightStickMacNativeProfile>
{
public InjusticeFightStickMacNativeProfileR(InControl.NativeDeviceProfiles.InjusticeFightStickMacNativeProfile _orig) : base(_orig) {}
