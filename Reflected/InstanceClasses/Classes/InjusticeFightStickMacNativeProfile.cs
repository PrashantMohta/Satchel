...
/// <summary>
///     A class that contains all (public and private) fields and methods of InjusticeFightStickMacNativeProfile allowing
///     you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class InjusticeFightStickMacNativeProfileR : InstanceClassWrapper<InjusticeFightStickMacNativeProfile>
{
    public InjusticeFightStickMacNativeProfileR(InjusticeFightStickMacNativeProfile _orig) : base(_orig)
    {
    }
