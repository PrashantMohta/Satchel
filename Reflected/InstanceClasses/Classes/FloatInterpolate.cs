...
/// </summary>
public class FloatInterpolateR:InstanceClassWrapper<HutongGames.PlayMaker.Actions.FloatInterpolate>
{
public FloatInterpolateR(HutongGames.PlayMaker.Actions.FloatInterpolate _orig) : base(_orig) {}
...
public HutongGames.PlayMaker.FsmFloat fromFloat
{
get => orig.fromFloat;
set => orig.fromFloat = value;
}

public HutongGames.PlayMaker.FsmFloat toFloat
{
get => orig.toFloat;
