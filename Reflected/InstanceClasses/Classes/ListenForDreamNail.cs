...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of ListenForDreamNail allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class ListenForDreamNailR:InstanceClassWrapper<HutongGames.PlayMaker.Actions.ListenForDreamNail>
{
public ListenForDreamNailR(HutongGames.PlayMaker.Actions.ListenForDreamNail _orig) : base(_orig) {}
