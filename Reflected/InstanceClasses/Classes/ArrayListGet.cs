...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of ArrayListGet allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class ArrayListGetR:InstanceClassWrapper<HutongGames.PlayMaker.Actions.ArrayListGet>
{
public ArrayListGetR(HutongGames.PlayMaker.Actions.ArrayListGet _orig) : base(_orig) {}
...
public HutongGames.PlayMaker.FsmInt atIndex
{
get => orig.atIndex;
set => orig.atIndex = value;
}
