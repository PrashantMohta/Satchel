...
/// </summary>
public class LineCast2dR:InstanceClassWrapper<HutongGames.PlayMaker.Actions.LineCast2d>
{
public LineCast2dR(HutongGames.PlayMaker.Actions.LineCast2d _orig) : base(_orig) {}
...
public UnityEngine.Transform _fromTrans
{
get => GetField<UnityEngine.Transform>();
set => SetField(value);
}

public UnityEngine.Transform _toTrans
{
get => GetField<UnityEngine.Transform>();
set => SetField(value);
}
