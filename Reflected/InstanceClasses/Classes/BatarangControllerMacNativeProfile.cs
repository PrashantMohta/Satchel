...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of BatarangControllerMacNativeProfile allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class BatarangControllerMacNativeProfileR:InstanceClassWrapper<InControl.NativeDeviceProfiles.BatarangControllerMacNativeProfile>
{
public BatarangControllerMacNativeProfileR(InControl.NativeDeviceProfiles.BatarangControllerMacNativeProfile _orig) : base(_orig) {}
