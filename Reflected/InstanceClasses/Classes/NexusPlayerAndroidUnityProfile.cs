...
/// </summary>
public class NexusPlayerAndroidUnityProfileR : InstanceClassWrapper<NexusPlayerAndroidUnityProfile>
{
    public NexusPlayerAndroidUnityProfileR(NexusPlayerAndroidUnityProfile _orig) : base(_orig)
    {
    }
