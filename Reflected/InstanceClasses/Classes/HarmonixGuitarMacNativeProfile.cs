...
/// </summary>
public class HarmonixGuitarMacNativeProfileR : InstanceClassWrapper<HarmonixGuitarMacNativeProfile>
{
    public HarmonixGuitarMacNativeProfileR(HarmonixGuitarMacNativeProfile _orig) : base(_orig)
    {
    }
