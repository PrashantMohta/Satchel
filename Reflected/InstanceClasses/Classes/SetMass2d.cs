...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of SetMass2d allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class SetMass2dR:InstanceClassWrapper<HutongGames.PlayMaker.Actions.SetMass2d>
{
public SetMass2dR(HutongGames.PlayMaker.Actions.SetMass2d _orig) : base(_orig) {}
...
public HutongGames.PlayMaker.FsmFloat mass
{
get => orig.mass;
set => orig.mass = value;
}
