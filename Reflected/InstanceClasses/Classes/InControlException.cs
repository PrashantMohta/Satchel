...
/// </summary>
public class InControlExceptionR:InstanceClassWrapper<InControl.InControlException>
{
public InControlExceptionR(InControl.InControlException _orig) : base(_orig) {}
