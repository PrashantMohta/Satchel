...
/// </summary>
public class uGuiSliderGetWholeNumbersR : InstanceClassWrapper<uGuiSliderGetWholeNumbers>
{
    public uGuiSliderGetWholeNumbersR(uGuiSliderGetWholeNumbers _orig) : base(_orig)
    {
    }
