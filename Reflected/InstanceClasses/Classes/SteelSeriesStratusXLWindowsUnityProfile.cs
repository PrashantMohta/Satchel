...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of SteelSeriesStratusXLWindowsUnityProfile allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class SteelSeriesStratusXLWindowsUnityProfileR:InstanceClassWrapper<InControl.UnityDeviceProfiles.SteelSeriesStratusXLWindowsUnityProfile>
{
public SteelSeriesStratusXLWindowsUnityProfileR(InControl.UnityDeviceProfiles.SteelSeriesStratusXLWindowsUnityProfile _orig) : base(_orig) {}
