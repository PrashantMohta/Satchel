...
/// </summary>
public class SamsungGP20AndroidUnityProfileR : InstanceClassWrapper<SamsungGP20AndroidUnityProfile>
{
    public SamsungGP20AndroidUnityProfileR(SamsungGP20AndroidUnityProfile _orig) : base(_orig)
    {
    }
