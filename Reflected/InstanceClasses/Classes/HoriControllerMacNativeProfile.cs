...
/// </summary>
public class HoriControllerMacNativeProfileR : InstanceClassWrapper<HoriControllerMacNativeProfile>
{
    public HoriControllerMacNativeProfileR(HoriControllerMacNativeProfile _orig) : base(_orig)
    {
    }
