...
/// <summary>
///     A class that contains all (public and private) fields and methods of MadCatzSSF4ChunLiFightStickTEMacNativeProfile
///     allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class
    MadCatzSSF4ChunLiFightStickTEMacNativeProfileR : InstanceClassWrapper<MadCatzSSF4ChunLiFightStickTEMacNativeProfile>
{
    public MadCatzSSF4ChunLiFightStickTEMacNativeProfileR(MadCatzSSF4ChunLiFightStickTEMacNativeProfile _orig) :
        base(_orig)
    {
    }
