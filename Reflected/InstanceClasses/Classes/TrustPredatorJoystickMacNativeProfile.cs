...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of TrustPredatorJoystickMacNativeProfile allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class TrustPredatorJoystickMacNativeProfileR:InstanceClassWrapper<InControl.NativeDeviceProfiles.TrustPredatorJoystickMacNativeProfile>
{
public TrustPredatorJoystickMacNativeProfileR(InControl.NativeDeviceProfiles.TrustPredatorJoystickMacNativeProfile _orig) : base(_orig) {}
