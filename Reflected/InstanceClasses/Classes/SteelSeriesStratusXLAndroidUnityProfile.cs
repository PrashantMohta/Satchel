...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of SteelSeriesStratusXLAndroidUnityProfile allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class SteelSeriesStratusXLAndroidUnityProfileR:InstanceClassWrapper<InControl.UnityDeviceProfiles.SteelSeriesStratusXLAndroidUnityProfile>
{
public SteelSeriesStratusXLAndroidUnityProfileR(InControl.UnityDeviceProfiles.SteelSeriesStratusXLAndroidUnityProfile _orig) : base(_orig) {}
