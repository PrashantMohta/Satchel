...
public UnityEngine.Camera hudCamera
{
get => orig.hudCamera;
...
{
get => GetField<UnityEngine.UI.CanvasScaler>();
set => SetField(value);
}
...
public GameCameras instance
{
get => GameCameras.instance;
}
