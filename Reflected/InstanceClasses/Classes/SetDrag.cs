...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of SetDrag allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class SetDragR:InstanceClassWrapper<HutongGames.PlayMaker.Actions.SetDrag>
{
public SetDragR(HutongGames.PlayMaker.Actions.SetDrag _orig) : base(_orig) {}
...
public HutongGames.PlayMaker.FsmFloat drag
{
get => orig.drag;
set => orig.drag = value;
}
