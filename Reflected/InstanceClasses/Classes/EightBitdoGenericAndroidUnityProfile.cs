...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of EightBitdoGenericAndroidUnityProfile allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class EightBitdoGenericAndroidUnityProfileR:InstanceClassWrapper<InControl.UnityDeviceProfiles.EightBitdoGenericAndroidUnityProfile>
{
public EightBitdoGenericAndroidUnityProfileR(InControl.UnityDeviceProfiles.EightBitdoGenericAndroidUnityProfile _orig) : base(_orig) {}
