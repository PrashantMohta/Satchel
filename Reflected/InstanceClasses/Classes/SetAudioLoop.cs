...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of SetAudioLoop allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class SetAudioLoopR:InstanceClassWrapper<HutongGames.PlayMaker.Actions.SetAudioLoop>
{
public SetAudioLoopR(HutongGames.PlayMaker.Actions.SetAudioLoop _orig) : base(_orig) {}
...
public HutongGames.PlayMaker.FsmBool loop
{
get => orig.loop;
set => orig.loop = value;
}
