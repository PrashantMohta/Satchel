...
/// </summary>
public class GUILayoutHorizontalSliderR : InstanceClassWrapper<GUILayoutHorizontalSlider>
{
    public GUILayoutHorizontalSliderR(GUILayoutHorizontalSlider _orig) : base(_orig)
    {
    }
