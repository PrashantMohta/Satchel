...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of GUILayoutHorizontalSlider allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class GUILayoutHorizontalSliderR:InstanceClassWrapper<HutongGames.PlayMaker.Actions.GUILayoutHorizontalSlider>
{
public GUILayoutHorizontalSliderR(HutongGames.PlayMaker.Actions.GUILayoutHorizontalSlider _orig) : base(_orig) {}
