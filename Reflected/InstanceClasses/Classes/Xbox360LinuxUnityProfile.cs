...
/// </summary>
public class Xbox360LinuxUnityProfileR : InstanceClassWrapper<Xbox360LinuxUnityProfile>
{
    public Xbox360LinuxUnityProfileR(Xbox360LinuxUnityProfile _orig) : base(_orig)
    {
    }
