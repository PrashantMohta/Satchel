...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of GetAnimatorCurrentStateInfoIsName allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class GetAnimatorCurrentStateInfoIsNameR:InstanceClassWrapper<HutongGames.PlayMaker.Actions.GetAnimatorCurrentStateInfoIsName>
{
public GetAnimatorCurrentStateInfoIsNameR(HutongGames.PlayMaker.Actions.GetAnimatorCurrentStateInfoIsName _orig) : base(_orig) {}
...
public HutongGames.PlayMaker.FsmBool isMatching
{
get => orig.isMatching;
set => orig.isMatching = value;
}
