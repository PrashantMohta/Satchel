...
/// </summary>
public class GetAxisVectorR:InstanceClassWrapper<HutongGames.PlayMaker.Actions.GetAxisVector>
{
public GetAxisVectorR(HutongGames.PlayMaker.Actions.GetAxisVector _orig) : base(_orig) {}
