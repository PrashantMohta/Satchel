...
/// </summary>
public class Xbox360AndroidUnityProfileR : InstanceClassWrapper<Xbox360AndroidUnityProfile>
{
    public Xbox360AndroidUnityProfileR(Xbox360AndroidUnityProfile _orig) : base(_orig)
    {
    }
