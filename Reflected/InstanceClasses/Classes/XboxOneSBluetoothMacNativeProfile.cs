...
/// <summary>
///     A class that contains all (public and private) fields and methods of XboxOneSBluetoothMacNativeProfile allowing you
///     to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class XboxOneSBluetoothMacNativeProfileR : InstanceClassWrapper<XboxOneSBluetoothMacNativeProfile>
{
    public XboxOneSBluetoothMacNativeProfileR(XboxOneSBluetoothMacNativeProfile _orig) : base(_orig)
    {
    }
