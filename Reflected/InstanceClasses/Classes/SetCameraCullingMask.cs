...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of SetCameraCullingMask allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class SetCameraCullingMaskR:InstanceClassWrapper<HutongGames.PlayMaker.Actions.SetCameraCullingMask>
{
public SetCameraCullingMaskR(HutongGames.PlayMaker.Actions.SetCameraCullingMask _orig) : base(_orig) {}
...
public HutongGames.PlayMaker.FsmInt[] cullingMask
{
get => orig.cullingMask;
set => orig.cullingMask = value;
}
...
public void DoSetCameraCullingMask () =>
CallMethod();
