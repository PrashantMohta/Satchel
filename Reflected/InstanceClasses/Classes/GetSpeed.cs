...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of GetSpeed allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class GetSpeedR:InstanceClassWrapper<HutongGames.PlayMaker.Actions.GetSpeed>
{
public GetSpeedR(HutongGames.PlayMaker.Actions.GetSpeed _orig) : base(_orig) {}
