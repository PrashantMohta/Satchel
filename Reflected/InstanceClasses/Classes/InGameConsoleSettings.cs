...
/// </summary>
public class InGameConsoleSettingsR:InstanceClassWrapper<Modding.InGameConsoleSettings>
{
public InGameConsoleSettingsR(Modding.InGameConsoleSettings _orig) : base(_orig) {}
...
public UnityEngine.KeyCode ToggleHotkey
{
