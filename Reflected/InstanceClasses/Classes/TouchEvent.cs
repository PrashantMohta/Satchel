...
/// </summary>
public class TouchEventR:InstanceClassWrapper<HutongGames.PlayMaker.Actions.TouchEvent>
{
public TouchEventR(HutongGames.PlayMaker.Actions.TouchEvent _orig) : base(_orig) {}
