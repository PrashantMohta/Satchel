...
/// </summary>
public class AndroidTVRemoteUnityProfileR : InstanceClassWrapper<AndroidTVRemoteUnityProfile>
{
    public AndroidTVRemoteUnityProfileR(AndroidTVRemoteUnityProfile _orig) : base(_orig)
    {
    }
