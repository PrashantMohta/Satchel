...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of AnimateFloat allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class AnimateFloatR:InstanceClassWrapper<HutongGames.PlayMaker.Actions.AnimateFloat>
{
public AnimateFloatR(HutongGames.PlayMaker.Actions.AnimateFloat _orig) : base(_orig) {}
