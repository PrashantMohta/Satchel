...
/// </summary>
public class OuyaWindowsUnityProfileR : InstanceClassWrapper<OuyaWindowsUnityProfile>
{
    public OuyaWindowsUnityProfileR(OuyaWindowsUnityProfile _orig) : base(_orig)
    {
    }
