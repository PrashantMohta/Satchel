...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of GetRaycastHitInfo allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class GetRaycastHitInfoR:InstanceClassWrapper<HutongGames.PlayMaker.Actions.GetRaycastHitInfo>
{
public GetRaycastHitInfoR(HutongGames.PlayMaker.Actions.GetRaycastHitInfo _orig) : base(_orig) {}
