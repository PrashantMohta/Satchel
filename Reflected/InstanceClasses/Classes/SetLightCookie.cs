...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of SetLightCookie allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class SetLightCookieR:InstanceClassWrapper<HutongGames.PlayMaker.Actions.SetLightCookie>
{
public SetLightCookieR(HutongGames.PlayMaker.Actions.SetLightCookie _orig) : base(_orig) {}
...
public HutongGames.PlayMaker.FsmTexture lightCookie
{
get => orig.lightCookie;
set => orig.lightCookie = value;
}
