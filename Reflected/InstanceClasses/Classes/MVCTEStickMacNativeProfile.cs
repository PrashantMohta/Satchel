...
/// </summary>
public class MVCTEStickMacNativeProfileR : InstanceClassWrapper<MVCTEStickMacNativeProfile>
{
    public MVCTEStickMacNativeProfileR(MVCTEStickMacNativeProfile _orig) : base(_orig)
    {
    }
