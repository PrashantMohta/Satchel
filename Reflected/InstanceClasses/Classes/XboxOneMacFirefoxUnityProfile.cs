...
/// </summary>
public class XboxOneMacFirefoxUnityProfileR : InstanceClassWrapper<XboxOneMacFirefoxUnityProfile>
{
    public XboxOneMacFirefoxUnityProfileR(XboxOneMacFirefoxUnityProfile _orig) : base(_orig)
    {
    }
