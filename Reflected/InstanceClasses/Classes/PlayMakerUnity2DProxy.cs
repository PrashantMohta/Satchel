...
public UnityEngine.Collision2D lastCollision2DInfo
{
get => orig.lastCollision2DInfo;
set => orig.lastCollision2DInfo = value;
}

public UnityEngine.Collider2D lastTrigger2DInfo
{
...
public void OnCollisionEnter2D (UnityEngine.Collision2D coll) =>
CallMethod(new object[] {coll});

public void OnCollisionStay2D (UnityEngine.Collision2D coll) =>
CallMethod(new object[] {coll});

public void OnCollisionExit2D (UnityEngine.Collision2D coll) =>
CallMethod(new object[] {coll});

public void OnTriggerEnter2D (UnityEngine.Collider2D coll) =>
CallMethod(new object[] {coll});

public void OnTriggerStay2D (UnityEngine.Collider2D coll) =>
CallMethod(new object[] {coll});

public void OnTriggerExit2D (UnityEngine.Collider2D coll) =>
CallMethod(new object[] {coll});
