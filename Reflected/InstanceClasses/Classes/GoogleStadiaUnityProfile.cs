...
/// </summary>
public class GoogleStadiaUnityProfileR : InstanceClassWrapper<GoogleStadiaUnityProfile>
{
    public GoogleStadiaUnityProfileR(GoogleStadiaUnityProfile _orig) : base(_orig)
    {
    }
