...
/// <summary>
///     A class that contains all (public and private) fields and methods of MadCatzSoulCaliberFightStickMacNativeProfile
///     allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class
    MadCatzSoulCaliberFightStickMacNativeProfileR : InstanceClassWrapper<MadCatzSoulCaliberFightStickMacNativeProfile>
{
    public MadCatzSoulCaliberFightStickMacNativeProfileR(MadCatzSoulCaliberFightStickMacNativeProfile _orig) :
        base(_orig)
    {
    }
