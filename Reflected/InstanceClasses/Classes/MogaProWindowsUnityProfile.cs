...
/// </summary>
public class MogaProWindowsUnityProfileR : InstanceClassWrapper<MogaProWindowsUnityProfile>
{
    public MogaProWindowsUnityProfileR(MogaProWindowsUnityProfile _orig) : base(_orig)
    {
    }
