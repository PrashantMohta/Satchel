...
/// </summary>
public class Xbox360DriverMacNativeProfileR : InstanceClassWrapper<Xbox360DriverMacNativeProfile>
{
    public Xbox360DriverMacNativeProfileR(Xbox360DriverMacNativeProfile _orig) : base(_orig)
    {
    }
