...
/// </summary>
public class GetNextRayCast2dR : InstanceClassWrapper<GetNextRayCast2d>
{
    public GetNextRayCast2dR(GetNextRayCast2d _orig) : base(_orig)
    {
    }
    ...
    public RaycastHit2D[] GetRayCastAll()
    {
