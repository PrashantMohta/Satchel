...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of AudioPlayRandomSingle allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class AudioPlayRandomSingleR:InstanceClassWrapper<HutongGames.PlayMaker.Actions.AudioPlayRandomSingle>
{
public AudioPlayRandomSingleR(HutongGames.PlayMaker.Actions.AudioPlayRandomSingle _orig) : base(_orig) {}
