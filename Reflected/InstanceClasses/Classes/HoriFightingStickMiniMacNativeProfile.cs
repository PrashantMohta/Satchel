...
/// <summary>
///     A class that contains all (public and private) fields and methods of HoriFightingStickMiniMacNativeProfile allowing
///     you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class HoriFightingStickMiniMacNativeProfileR : InstanceClassWrapper<HoriFightingStickMiniMacNativeProfile>
{
    public HoriFightingStickMiniMacNativeProfileR(HoriFightingStickMiniMacNativeProfile _orig) : base(_orig)
    {
    }
