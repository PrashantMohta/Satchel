...
/// </summary>
public class XInputWindowsNativeProfileR : InstanceClassWrapper<XInputWindowsNativeProfile>
{
    public XInputWindowsNativeProfileR(XInputWindowsNativeProfile _orig) : base(_orig)
    {
    }
