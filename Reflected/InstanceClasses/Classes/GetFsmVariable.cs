...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of GetFsmVariable allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class GetFsmVariableR:InstanceClassWrapper<HutongGames.PlayMaker.Actions.GetFsmVariable>
{
public GetFsmVariableR(HutongGames.PlayMaker.Actions.GetFsmVariable _orig) : base(_orig) {}
...
public HutongGames.PlayMaker.FsmVar storeValue
{
get => orig.storeValue;
...
public void InitFsmVar () =>
CallMethod();

public void DoGetFsmVariable () =>
CallMethod();
