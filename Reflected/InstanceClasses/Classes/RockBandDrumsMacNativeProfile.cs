...
/// </summary>
public class RockBandDrumsMacNativeProfileR : InstanceClassWrapper<RockBandDrumsMacNativeProfile>
{
    public RockBandDrumsMacNativeProfileR(RockBandDrumsMacNativeProfile _orig) : base(_orig)
    {
    }
