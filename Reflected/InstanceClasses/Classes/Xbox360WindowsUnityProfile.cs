...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of Xbox360WindowsUnityProfile allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class Xbox360WindowsUnityProfileR:InstanceClassWrapper<InControl.UnityDeviceProfiles.Xbox360WindowsUnityProfile>
{
public Xbox360WindowsUnityProfileR(InControl.UnityDeviceProfiles.Xbox360WindowsUnityProfile _orig) : base(_orig) {}
