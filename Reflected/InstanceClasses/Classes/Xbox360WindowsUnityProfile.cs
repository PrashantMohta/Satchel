...
/// </summary>
public class Xbox360WindowsUnityProfileR : InstanceClassWrapper<Xbox360WindowsUnityProfile>
{
    public Xbox360WindowsUnityProfileR(Xbox360WindowsUnityProfile _orig) : base(_orig)
    {
    }
