...
/// </summary>
public class HashTableGetKeyFromValueR : InstanceClassWrapper<HashTableGetKeyFromValue>
{
    public HashTableGetKeyFromValueR(HashTableGetKeyFromValue _orig) : base(_orig)
    {
    }
