...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of ListenForMenuSubmit allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class ListenForMenuSubmitR:InstanceClassWrapper<HutongGames.PlayMaker.Actions.ListenForMenuSubmit>
{
public ListenForMenuSubmitR(HutongGames.PlayMaker.Actions.ListenForMenuSubmit _orig) : base(_orig) {}
