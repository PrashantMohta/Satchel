...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of SetLightIntensity allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class SetLightIntensityR:InstanceClassWrapper<HutongGames.PlayMaker.Actions.SetLightIntensity>
{
public SetLightIntensityR(HutongGames.PlayMaker.Actions.SetLightIntensity _orig) : base(_orig) {}
...
public HutongGames.PlayMaker.FsmFloat lightIntensity
{
get => orig.lightIntensity;
set => orig.lightIntensity = value;
}
...
public void DoSetLightIntensity () =>
CallMethod();
