...
/// </summary>
public class XTR_G2_WindowsUnityProfileR : InstanceClassWrapper<XTR_G2_WindowsUnityProfile>
{
    public XTR_G2_WindowsUnityProfileR(XTR_G2_WindowsUnityProfile _orig) : base(_orig)
    {
    }
