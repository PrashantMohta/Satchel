...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of LogitechF310ModeDMacUnityProfile allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class LogitechF310ModeDMacUnityProfileR:InstanceClassWrapper<InControl.UnityDeviceProfiles.LogitechF310ModeDMacUnityProfile>
{
public LogitechF310ModeDMacUnityProfileR(InControl.UnityDeviceProfiles.LogitechF310ModeDMacUnityProfile _orig) : base(_orig) {}
