...
/// </summary>
public class XTR_G2_MacNativeProfileR : InstanceClassWrapper<XTR_G2_MacNativeProfile>
{
    public XTR_G2_MacNativeProfileR(XTR_G2_MacNativeProfile _orig) : base(_orig)
    {
    }
