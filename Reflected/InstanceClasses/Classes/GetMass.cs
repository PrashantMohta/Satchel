...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of GetMass allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class GetMassR:InstanceClassWrapper<HutongGames.PlayMaker.Actions.GetMass>
{
public GetMassR(HutongGames.PlayMaker.Actions.GetMass _orig) : base(_orig) {}
