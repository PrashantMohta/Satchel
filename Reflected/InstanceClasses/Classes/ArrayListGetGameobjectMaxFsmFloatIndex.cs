...
/// <summary>
///     A class that contains all (public and private) fields and methods of ArrayListGetGameobjectMaxFsmFloatIndex
///     allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class ArrayListGetGameobjectMaxFsmFloatIndexR : InstanceClassWrapper<ArrayListGetGameobjectMaxFsmFloatIndex>
{
    public ArrayListGetGameobjectMaxFsmFloatIndexR(ArrayListGetGameobjectMaxFsmFloatIndex _orig) : base(_orig)
    {
    }
