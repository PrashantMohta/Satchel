...
/// </summary>
public class IpegaPG9021AndroidUnityProfileR : InstanceClassWrapper<IpegaPG9021AndroidUnityProfile>
{
    public IpegaPG9021AndroidUnityProfileR(IpegaPG9021AndroidUnityProfile _orig) : base(_orig)
    {
    }
