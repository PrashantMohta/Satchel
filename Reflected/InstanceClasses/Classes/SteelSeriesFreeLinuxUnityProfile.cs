...
/// <summary>
///     A class that contains all (public and private) fields and methods of SteelSeriesFreeLinuxUnityProfile allowing you
///     to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class SteelSeriesFreeLinuxUnityProfileR : InstanceClassWrapper<SteelSeriesFreeLinuxUnityProfile>
{
    public SteelSeriesFreeLinuxUnityProfileR(SteelSeriesFreeLinuxUnityProfile _orig) : base(_orig)
    {
    }
