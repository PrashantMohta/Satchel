...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of PlayStation4SteamLinkMacUnityProfile allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class PlayStation4SteamLinkMacUnityProfileR:InstanceClassWrapper<InControl.UnityDeviceProfiles.PlayStation4SteamLinkMacUnityProfile>
{
public PlayStation4SteamLinkMacUnityProfileR(InControl.UnityDeviceProfiles.PlayStation4SteamLinkMacUnityProfile _orig) : base(_orig) {}
