...
/// </summary>
public class XboxOneWindows10NativeProfileR : InstanceClassWrapper<XboxOneWindows10NativeProfile>
{
    public XboxOneWindows10NativeProfileR(XboxOneWindows10NativeProfile _orig) : base(_orig)
    {
    }
