...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of EightBitdoSFC30MacNativeProfile allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class EightBitdoSFC30MacNativeProfileR:InstanceClassWrapper<InControl.NativeDeviceProfiles.EightBitdoSFC30MacNativeProfile>
{
public EightBitdoSFC30MacNativeProfileR(InControl.NativeDeviceProfiles.EightBitdoSFC30MacNativeProfile _orig) : base(_orig) {}
