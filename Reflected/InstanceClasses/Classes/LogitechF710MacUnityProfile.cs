...
/// </summary>
public class LogitechF710MacUnityProfileR : InstanceClassWrapper<LogitechF710MacUnityProfile>
{
    public LogitechF710MacUnityProfileR(LogitechF710MacUnityProfile _orig) : base(_orig)
    {
    }
