...
/// <summary>
///     A class that contains all (public and private) fields and methods of CorpseChunker allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class CorpseChunkerR : InstanceClassWrapper<CorpseChunker>
{
    public CorpseChunkerR(CorpseChunker _orig) : base(_orig)
    {
    }
