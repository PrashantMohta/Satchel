...
/// </summary>
public class BlendAnimationR : InstanceClassWrapper<BlendAnimation>
{
    public BlendAnimationR(BlendAnimation _orig) : base(_orig)
    {
    }
    ...
    public DelayedEvent delayedFinishEvent
    {
    ...
    public void DoBlendAnimation(GameObject go)
    {
