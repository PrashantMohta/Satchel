...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of QanbaFightStickPlusMacNativeProfile allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class QanbaFightStickPlusMacNativeProfileR:InstanceClassWrapper<InControl.NativeDeviceProfiles.QanbaFightStickPlusMacNativeProfile>
{
public QanbaFightStickPlusMacNativeProfileR(InControl.NativeDeviceProfiles.QanbaFightStickPlusMacNativeProfile _orig) : base(_orig) {}
