...
///     RazerWolverineUltimateControllerMacNativeProfile allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class
    RazerWolverineUltimateControllerMacNativeProfileR : InstanceClassWrapper<
        RazerWolverineUltimateControllerMacNativeProfile>
{
    public RazerWolverineUltimateControllerMacNativeProfileR(RazerWolverineUltimateControllerMacNativeProfile _orig) :
        base(_orig)
    {
    }
