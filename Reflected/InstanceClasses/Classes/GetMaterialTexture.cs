...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of GetMaterialTexture allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class GetMaterialTextureR:InstanceClassWrapper<HutongGames.PlayMaker.Actions.GetMaterialTexture>
{
public GetMaterialTextureR(HutongGames.PlayMaker.Actions.GetMaterialTexture _orig) : base(_orig) {}
...
public HutongGames.PlayMaker.FsmTexture storedTexture
{
get => orig.storedTexture;
set => orig.storedTexture = value;
}

public bool getFromSharedMaterial
{
get => orig.getFromSharedMaterial;
set => orig.getFromSharedMaterial = value;
}
...
public void DoGetMaterialTexture () =>
CallMethod();
