...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of SpeedlinkStrikeWindowsUnityProfile allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class SpeedlinkStrikeWindowsUnityProfileR:InstanceClassWrapper<InControl.UnityDeviceProfiles.SpeedlinkStrikeWindowsUnityProfile>
{
public SpeedlinkStrikeWindowsUnityProfileR(InControl.UnityDeviceProfiles.SpeedlinkStrikeWindowsUnityProfile _orig) : base(_orig) {}
