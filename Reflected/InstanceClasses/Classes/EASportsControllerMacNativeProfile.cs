...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of EASportsControllerMacNativeProfile allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class EASportsControllerMacNativeProfileR:InstanceClassWrapper<InControl.NativeDeviceProfiles.EASportsControllerMacNativeProfile>
{
public EASportsControllerMacNativeProfileR(InControl.NativeDeviceProfiles.EASportsControllerMacNativeProfile _orig) : base(_orig) {}
