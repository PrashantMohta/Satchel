...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of GetFsmString allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class GetFsmStringR:InstanceClassWrapper<HutongGames.PlayMaker.Actions.GetFsmString>
{
public GetFsmStringR(HutongGames.PlayMaker.Actions.GetFsmString _orig) : base(_orig) {}
