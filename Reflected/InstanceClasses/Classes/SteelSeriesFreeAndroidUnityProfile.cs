...
/// <summary>
///     A class that contains all (public and private) fields and methods of SteelSeriesFreeAndroidUnityProfile allowing
///     you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class SteelSeriesFreeAndroidUnityProfileR : InstanceClassWrapper<SteelSeriesFreeAndroidUnityProfile>
{
    public SteelSeriesFreeAndroidUnityProfileR(SteelSeriesFreeAndroidUnityProfile _orig) : base(_orig)
    {
    }
