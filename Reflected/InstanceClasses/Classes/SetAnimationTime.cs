...
/// </summary>
public class SetAnimationTimeR : InstanceClassWrapper<SetAnimationTime>
{
    public SetAnimationTimeR(SetAnimationTime _orig) : base(_orig)
    {
    }
    ...
    public void DoSetAnimationTime(GameObject go)
    {
