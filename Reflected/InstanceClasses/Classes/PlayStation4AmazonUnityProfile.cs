...
/// </summary>
public class PlayStation4AmazonUnityProfileR : InstanceClassWrapper<PlayStation4AmazonUnityProfile>
{
    public PlayStation4AmazonUnityProfileR(PlayStation4AmazonUnityProfile _orig) : base(_orig)
    {
    }
