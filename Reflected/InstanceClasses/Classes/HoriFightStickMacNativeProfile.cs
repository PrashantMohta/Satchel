...
/// </summary>
public class HoriFightStickMacNativeProfileR : InstanceClassWrapper<HoriFightStickMacNativeProfile>
{
    public HoriFightStickMacNativeProfileR(HoriFightStickMacNativeProfile _orig) : base(_orig)
    {
    }
