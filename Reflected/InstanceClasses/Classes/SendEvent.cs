...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of SendEvent allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class SendEventR:InstanceClassWrapper<HutongGames.PlayMaker.Actions.SendEvent>
{
public SendEventR(HutongGames.PlayMaker.Actions.SendEvent _orig) : base(_orig) {}
