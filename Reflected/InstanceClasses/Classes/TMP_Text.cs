...
/// </summary>
public class TMP_TextR:InstanceClassWrapper<TMPro.TMP_Text>
{
public TMP_TextR(TMPro.TMP_Text _orig) : base(_orig) {}
...
public UnityEngine.Color32 s_colorWhite
{
get => GetFieldStatic<UnityEngine.Color32>();
set => SetField(value);
}
...
public TMPro.TMP_CharacterInfo[] m_internalCharacterInfo
{
get => GetField<TMPro.TMP_CharacterInfo[]>();
set => SetField(value);
}
...
public System.Single[] k_Power
{
get => GetField<System.Single[]>();
set => SetField(value);
}

public UnityEngine.Vector2 k_LargePositiveVector2
{
get => GetFieldStatic<UnityEngine.Vector2>();
set => SetField(value);
}

public UnityEngine.Vector2 k_LargeNegativeVector2
{
get => GetFieldStatic<UnityEngine.Vector2>();
set => SetField(value);
}
...
public void SetFontBaseMaterial (UnityEngine.Material mat) =>
CallMethod(new object[] {mat});
...
public void SetVertexColorGradient (TMPro.TMP_ColorGradient gradient) =>
...
public void SetVertices (UnityEngine.Vector3[] vertices) =>
orig.SetVertices(vertices);

public void UpdateMeshPadding () =>
orig.UpdateMeshPadding();

public void CrossFadeColor (UnityEngine.Color targetColor, float duration, bool ignoreTimeScale, bool useAlpha) =>
...
public void SetCharArray (System.Char[] charArray) =>
orig.SetCharArray(charArray);

public void SetTextArrayToCharArray (System.Char[] charArray, System.Int32[] charBuffer) =>
CallMethod(new object[] {charArray, charBuffer});

public void StringToCharArray (string text, System.Int32[] chars) =>
CallMethod(new object[] {text, chars});

public void StringBuilderToIntArray (System.Text.StringBuilder text, System.Int32[] chars) =>
CallMethod(new object[] {text, chars});
...
orig.GetPreferredValues();

public UnityEngine.Vector2 GetPreferredValues (float width, float height) =>
orig.GetPreferredValues(width, height);

public UnityEngine.Vector2 GetPreferredValues (string text) =>
orig.GetPreferredValues(text);

public UnityEngine.Vector2 GetPreferredValues (string text, float width, float height) =>
orig.GetPreferredValues(text, width, height);

public float GetPreferredWidth () =>
CallMethod<float>();

public float GetPreferredWidth (UnityEngine.Vector2 margin) =>
CallMethod<float>(new object[] {margin});

public float GetPreferredHeight () =>
CallMethod<float>();

public float GetPreferredHeight (UnityEngine.Vector2 margin) =>
CallMethod<float>(new object[] {margin});

public UnityEngine.Vector2 GetRenderedValues () =>
orig.GetRenderedValues();
...
public UnityEngine.Vector2 CalculatePreferredValues (float defaultFontSize, UnityEngine.Vector2 marginSize) =>
CallMethod<UnityEngine.Vector2>(new object[] {defaultFontSize, marginSize});

public UnityEngine.Bounds GetCompoundBounds () =>
CallMethod<UnityEngine.Bounds>();

public UnityEngine.Bounds GetTextBounds () =>
CallMethod<UnityEngine.Bounds>();
...
public int GetArraySizes (System.Int32[] chars) =>
CallMethod<int>(new object[] {chars});

public void SaveWordWrappingState (TMPro.WordWrapState state, int index, int count) =>
CallMethod(new object[] {state, index, count});

public int RestoreWordWrappingState (TMPro.WordWrapState state) =>
CallMethod<int>(new object[] {state});

public void SaveGlyphVertexInfo (float padding, float style_padding, UnityEngine.Color32 vertexColor) =>
CallMethod(new object[] {padding, style_padding, vertexColor});

public void SaveSpriteVertexInfo (UnityEngine.Color32 vertexColor) =>
...
public void DrawUnderlineMesh (UnityEngine.Vector3 start, UnityEngine.Vector3 end, int index, float startScale, float endScale, float maxScale, float sdfScale, UnityEngine.Color32 underlineColor) =>
CallMethod(new object[] {start, end, index, startScale, endScale, maxScale, sdfScale, underlineColor});

public void GetSpecialCharacters (TMPro.TMP_FontAsset fontAsset) =>
CallMethod(new object[] {fontAsset});

public TMPro.TMP_FontAsset GetFontAssetForWeight (int fontWeight) =>
CallMethod<TMPro.TMP_FontAsset>(new object[] {fontWeight});

public void SetActiveSubMeshes (bool state) =>
CallMethod(new object[] {state});

public UnityEngine.Vector2 PackUV (float x, float y, float scale) =>
CallMethod<UnityEngine.Vector2>(new object[] {x, y, scale});

public float PackUV (float x, float y) =>
CallMethod<float>(new object[] {x, y});

public int HexToInt (System.Char hex) =>
CallMethod<int>(new object[] {hex});

public int GetUTF16 (int i) =>
CallMethod<int>(new object[] {i});

public int GetUTF32 (int i) =>
CallMethod<int>(new object[] {i});

public UnityEngine.Color32 HexCharsToColor (System.Char[] hexChars, int tagCount) =>
CallMethod<UnityEngine.Color32>(new object[] {hexChars, tagCount});

public UnityEngine.Color32 HexCharsToColor (System.Char[] hexChars, int startIndex, int length) =>
CallMethod<UnityEngine.Color32>(new object[] {hexChars, startIndex, length});

public float ConvertToFloat (System.Char[] chars, int startIndex, int length, int decimalPointIndex) =>
CallMethod<float>(new object[] {chars, startIndex, length, decimalPointIndex});

public bool ValidateHtmlTag (System.Int32[] chars, int startIndex, int endIndex) =>
CallMethod<bool>(new object[] {chars, startIndex, endIndex});
