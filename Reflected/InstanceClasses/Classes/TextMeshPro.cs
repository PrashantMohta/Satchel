...
/// </summary>
public class TextMeshProR:InstanceClassWrapper<TMPro.TextMeshPro>
{
public TextMeshProR(TMPro.TextMeshPro _orig) : base(_orig) {}
...
public UnityEngine.Bounds m_default_bounds
{
get => GetField<UnityEngine.Bounds>();
set => SetField(value);
}

public TMPro.TMP_SubMesh[] m_subTextObjects
{
get => GetField<TMPro.TMP_SubMesh[]>();
set => SetField(value);
}
...
public TMPro.MaskingTypes m_maskType
{
get => GetField<TMPro.MaskingTypes>();
set => SetField(value);
}
...
public TMPro.TextContainer m_textContainer
{
get => GetField<TMPro.TextContainer>();
set => SetField(value);
}
...
public TMPro.MaskingTypes maskType
{
get => orig.maskType;
...
public void SetMask (TMPro.MaskingTypes maskType) =>
CallMethod(new object[] {maskType});

public void SetMaskCoordinates (UnityEngine.Vector4 coords) =>
CallMethod(new object[] {coords});

public void SetMaskCoordinates (UnityEngine.Vector4 coords, float softX, float softY) =>
...
public void SetMask (TMPro.MaskingTypes type, UnityEngine.Vector4 maskCoords) =>
orig.SetMask(type, maskCoords);

public void SetMask (TMPro.MaskingTypes type, UnityEngine.Vector4 maskCoords, float softnessX, float softnessY) =>
