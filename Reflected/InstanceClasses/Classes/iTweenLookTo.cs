...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of iTweenLookTo allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class iTweenLookToR:InstanceClassWrapper<HutongGames.PlayMaker.Actions.iTweenLookTo>
{
public iTweenLookToR(HutongGames.PlayMaker.Actions.iTweenLookTo _orig) : base(_orig) {}
