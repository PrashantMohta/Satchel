...
/// </summary>
public class XboxOneMacSafariUnityProfileR : InstanceClassWrapper<XboxOneMacSafariUnityProfile>
{
    public XboxOneMacSafariUnityProfileR(XboxOneMacSafariUnityProfile _orig) : base(_orig)
    {
    }
