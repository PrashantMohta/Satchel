...
public class CheatManagerR : InstanceClassWrapper<CheatManager>
{
    ...
    public bool IsCheatsEnabled => CheatManager.IsCheatsEnabled;

    public bool IsInstaKillEnabled => CheatManager.IsInstaKillEnabled;
    ...
    {
        return CallMethod<bool>(new object[] { buttonIndex, content });
    }
