...
/// <summary>
///     A class that contains all (public and private) fields and methods of BETAOPControllerMacNativeProfile allowing you
///     to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class BETAOPControllerMacNativeProfileR : InstanceClassWrapper<BETAOPControllerMacNativeProfile>
{
    public BETAOPControllerMacNativeProfileR(BETAOPControllerMacNativeProfile _orig) : base(_orig)
    {
    }
