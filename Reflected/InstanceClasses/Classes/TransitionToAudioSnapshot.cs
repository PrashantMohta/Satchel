...
/// </summary>
public class TransitionToAudioSnapshotR : InstanceClassWrapper<TransitionToAudioSnapshot>
{
    public TransitionToAudioSnapshotR(TransitionToAudioSnapshot _orig) : base(_orig)
    {
    }
