...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of TransitionToAudioSnapshot allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class TransitionToAudioSnapshotR:InstanceClassWrapper<HutongGames.PlayMaker.Actions.TransitionToAudioSnapshot>
{
public TransitionToAudioSnapshotR(HutongGames.PlayMaker.Actions.TransitionToAudioSnapshot _orig) : base(_orig) {}
public HutongGames.PlayMaker.FsmObject snapshot
{
get => orig.snapshot;
set => orig.snapshot = value;
}
