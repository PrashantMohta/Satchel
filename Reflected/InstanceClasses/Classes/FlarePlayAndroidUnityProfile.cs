...
/// </summary>
public class FlarePlayAndroidUnityProfileR : InstanceClassWrapper<FlarePlayAndroidUnityProfile>
{
    public FlarePlayAndroidUnityProfileR(FlarePlayAndroidUnityProfile _orig) : base(_orig)
    {
    }
