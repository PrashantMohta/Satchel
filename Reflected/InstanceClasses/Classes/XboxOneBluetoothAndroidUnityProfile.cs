...
/// <summary>
///     A class that contains all (public and private) fields and methods of XboxOneBluetoothAndroidUnityProfile allowing
///     you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class XboxOneBluetoothAndroidUnityProfileR : InstanceClassWrapper<XboxOneBluetoothAndroidUnityProfile>
{
    public XboxOneBluetoothAndroidUnityProfileR(XboxOneBluetoothAndroidUnityProfile _orig) : base(_orig)
    {
    }
