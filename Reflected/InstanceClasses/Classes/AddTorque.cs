...
/// </summary>
public class AddTorqueR:InstanceClassWrapper<HutongGames.PlayMaker.Actions.AddTorque>
{
public AddTorqueR(HutongGames.PlayMaker.Actions.AddTorque _orig) : base(_orig) {}
