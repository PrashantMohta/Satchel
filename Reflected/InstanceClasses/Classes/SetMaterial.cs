...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of SetMaterial allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class SetMaterialR:InstanceClassWrapper<HutongGames.PlayMaker.Actions.SetMaterial>
{
public SetMaterialR(HutongGames.PlayMaker.Actions.SetMaterial _orig) : base(_orig) {}
