...
/// <summary>
///     A class that contains all (public and private) fields and methods of HoriFightingEdgeArcadeStickMacNativeProfile
///     allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class
    HoriFightingEdgeArcadeStickMacNativeProfileR : InstanceClassWrapper<HoriFightingEdgeArcadeStickMacNativeProfile>
{
    public HoriFightingEdgeArcadeStickMacNativeProfileR(HoriFightingEdgeArcadeStickMacNativeProfile _orig) : base(_orig)
    {
    }
