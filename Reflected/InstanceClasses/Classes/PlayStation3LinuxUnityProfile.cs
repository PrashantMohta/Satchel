...
/// </summary>
public class PlayStation3LinuxUnityProfileR : InstanceClassWrapper<PlayStation3LinuxUnityProfile>
{
    public PlayStation3LinuxUnityProfileR(PlayStation3LinuxUnityProfile _orig) : base(_orig)
    {
    }
