...
public class BossSceneControllerR : InstanceClassWrapper<BossSceneController>
{
    ...
    public Action OnBossesDead
    {
        get => GetField<Action>();
        set => SetField(value);
    }

    public Action OnBossSceneComplete
    {
        get => GetField<Action>();
        set => SetField(value);
    }
    ...
    public bool IsBossScene => BossSceneController.IsBossScene;
    ...
    public bool IsTransitioning => BossSceneController.IsTransitioning;
    ...
    public Dictionary<HealthManager, BossSceneController.BossHealthDetails> BossHealthLookup
    {
    ...
    public IEnumerator EndSceneDelayed()
    {
        return CallMethod<IEnumerator>();
    }
