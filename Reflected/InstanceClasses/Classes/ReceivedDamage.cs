...
/// </summary>
public class ReceivedDamageR:InstanceClassWrapper<HutongGames.PlayMaker.Actions.ReceivedDamage>
{
public ReceivedDamageR(HutongGames.PlayMaker.Actions.ReceivedDamage _orig) : base(_orig) {}
...
public HutongGames.PlayMaker.FsmBool ignoreWater
{
...
public void StoreTriggerInfo (UnityEngine.Collider2D collisionInfo) =>
CallMethod(new object[] {collisionInfo});
