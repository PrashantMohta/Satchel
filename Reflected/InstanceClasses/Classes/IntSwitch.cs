...
/// </summary>
public class IntSwitchR:InstanceClassWrapper<HutongGames.PlayMaker.Actions.IntSwitch>
{
public IntSwitchR(HutongGames.PlayMaker.Actions.IntSwitch _orig) : base(_orig) {}
...
public HutongGames.PlayMaker.FsmInt[] compareTo
{
get => orig.compareTo;
