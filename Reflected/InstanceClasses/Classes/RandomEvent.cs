...
/// </summary>
public class RandomEventR : InstanceClassWrapper<RandomEvent>
{
    public RandomEventR(RandomEvent _orig) : base(_orig)
    {
    }
    ...
    public FsmEvent GetRandomEvent()
    {
        return CallMethod<FsmEvent>();
    }
}