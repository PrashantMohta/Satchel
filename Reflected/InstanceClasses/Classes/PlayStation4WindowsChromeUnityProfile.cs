...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of PlayStation4WindowsChromeUnityProfile allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class PlayStation4WindowsChromeUnityProfileR:InstanceClassWrapper<InControl.UnityDeviceProfiles.PlayStation4WindowsChromeUnityProfile>
{
public PlayStation4WindowsChromeUnityProfileR(InControl.UnityDeviceProfiles.PlayStation4WindowsChromeUnityProfile _orig) : base(_orig) {}
