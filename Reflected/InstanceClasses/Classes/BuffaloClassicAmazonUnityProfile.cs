...
/// <summary>
///     A class that contains all (public and private) fields and methods of BuffaloClassicAmazonUnityProfile allowing you
///     to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class BuffaloClassicAmazonUnityProfileR : InstanceClassWrapper<BuffaloClassicAmazonUnityProfile>
{
    public BuffaloClassicAmazonUnityProfileR(BuffaloClassicAmazonUnityProfile _orig) : base(_orig)
    {
    }
