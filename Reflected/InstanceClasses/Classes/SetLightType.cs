...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of SetLightType allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class SetLightTypeR:InstanceClassWrapper<HutongGames.PlayMaker.Actions.SetLightType>
{
public SetLightTypeR(HutongGames.PlayMaker.Actions.SetLightType _orig) : base(_orig) {}
...
public HutongGames.PlayMaker.FsmEnum lightType
{
get => orig.lightType;
set => orig.lightType = value;
}
