...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of EightBitdoSFC30AndroidUnityProfile allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class EightBitdoSFC30AndroidUnityProfileR:InstanceClassWrapper<InControl.UnityDeviceProfiles.EightBitdoSFC30AndroidUnityProfile>
{
public EightBitdoSFC30AndroidUnityProfileR(InControl.UnityDeviceProfiles.EightBitdoSFC30AndroidUnityProfile _orig) : base(_orig) {}
