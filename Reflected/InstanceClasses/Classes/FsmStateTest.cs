...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of FsmStateTest allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class FsmStateTestR:InstanceClassWrapper<HutongGames.PlayMaker.Actions.FsmStateTest>
{
public FsmStateTestR(HutongGames.PlayMaker.Actions.FsmStateTest _orig) : base(_orig) {}
