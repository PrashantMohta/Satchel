...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of SetAudioVolume allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class SetAudioVolumeR:InstanceClassWrapper<HutongGames.PlayMaker.Actions.SetAudioVolume>
{
public SetAudioVolumeR(HutongGames.PlayMaker.Actions.SetAudioVolume _orig) : base(_orig) {}
