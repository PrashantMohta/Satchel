...
/// <summary>
///     A class that contains all (public and private) fields and methods of XInputWindowsFirefoxUnityProfile allowing you
///     to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class XInputWindowsFirefoxUnityProfileR : InstanceClassWrapper<XInputWindowsFirefoxUnityProfile>
{
    public XInputWindowsFirefoxUnityProfileR(XInputWindowsFirefoxUnityProfile _orig) : base(_orig)
    {
    }
