...
/// </summary>
public class GUILayoutConfirmPasswordFieldR:InstanceClassWrapper<HutongGames.PlayMaker.Actions.GUILayoutConfirmPasswordField>
{
public GUILayoutConfirmPasswordFieldR(HutongGames.PlayMaker.Actions.GUILayoutConfirmPasswordField _orig) : base(_orig) {}
...
public HutongGames.PlayMaker.FsmInt maxLength
{
get => orig.maxLength;
...
public HutongGames.PlayMaker.FsmString mask
{
get => orig.mask;
set => orig.mask = value;
}

public HutongGames.PlayMaker.FsmBool confirm
{
get => orig.confirm;
set => orig.confirm = value;
}

public HutongGames.PlayMaker.FsmString password
{
get => orig.password;
