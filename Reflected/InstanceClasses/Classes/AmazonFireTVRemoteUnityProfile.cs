...
/// </summary>
public class AmazonFireTVRemoteUnityProfileR : InstanceClassWrapper<AmazonFireTVRemoteUnityProfile>
{
    public AmazonFireTVRemoteUnityProfileR(AmazonFireTVRemoteUnityProfile _orig) : base(_orig)
    {
    }
