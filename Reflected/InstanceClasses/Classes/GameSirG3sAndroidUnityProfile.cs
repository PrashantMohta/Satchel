...
/// </summary>
public class GameSirG3sAndroidUnityProfileR : InstanceClassWrapper<GameSirG3sAndroidUnityProfile>
{
    public GameSirG3sAndroidUnityProfileR(GameSirG3sAndroidUnityProfile _orig) : base(_orig)
    {
    }
