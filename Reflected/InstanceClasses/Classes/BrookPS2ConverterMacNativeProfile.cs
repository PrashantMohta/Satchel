...
/// <summary>
///     A class that contains all (public and private) fields and methods of BrookPS2ConverterMacNativeProfile allowing you
///     to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class BrookPS2ConverterMacNativeProfileR : InstanceClassWrapper<BrookPS2ConverterMacNativeProfile>
{
    public BrookPS2ConverterMacNativeProfileR(BrookPS2ConverterMacNativeProfile _orig) : base(_orig)
    {
    }
