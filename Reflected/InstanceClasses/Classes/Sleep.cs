...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of Sleep allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class SleepR:InstanceClassWrapper<HutongGames.PlayMaker.Actions.Sleep>
{
public SleepR(HutongGames.PlayMaker.Actions.Sleep _orig) : base(_orig) {}
