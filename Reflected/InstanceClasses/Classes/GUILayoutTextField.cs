...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of GUILayoutTextField allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class GUILayoutTextFieldR:InstanceClassWrapper<HutongGames.PlayMaker.Actions.GUILayoutTextField>
{
public GUILayoutTextFieldR(HutongGames.PlayMaker.Actions.GUILayoutTextField _orig) : base(_orig) {}
