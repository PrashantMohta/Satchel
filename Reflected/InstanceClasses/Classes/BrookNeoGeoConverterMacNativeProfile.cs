...
/// <summary>
///     A class that contains all (public and private) fields and methods of BrookNeoGeoConverterMacNativeProfile allowing
///     you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class BrookNeoGeoConverterMacNativeProfileR : InstanceClassWrapper<BrookNeoGeoConverterMacNativeProfile>
{
    public BrookNeoGeoConverterMacNativeProfileR(BrookNeoGeoConverterMacNativeProfile _orig) : base(_orig)
    {
    }
