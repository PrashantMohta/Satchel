...
/// </summary>
public class TransformInputToWorldSpaceR : InstanceClassWrapper<TransformInputToWorldSpace>
{
    public TransformInputToWorldSpaceR(TransformInputToWorldSpace _orig) : base(_orig)
    {
    }
