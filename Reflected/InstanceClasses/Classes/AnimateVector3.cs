...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of AnimateVector3 allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class AnimateVector3R:InstanceClassWrapper<HutongGames.PlayMaker.Actions.AnimateVector3>
{
public AnimateVector3R(HutongGames.PlayMaker.Actions.AnimateVector3 _orig) : base(_orig) {}
public HutongGames.PlayMaker.FsmVector3 vectorVariable
{
...
public HutongGames.PlayMaker.FsmAnimationCurve curveZ
{
get => orig.curveZ;
...
public HutongGames.PlayMaker.Actions.AnimateFsmAction.Calculation[] calculations
{
get => GetField<HutongGames.PlayMaker.Actions.AnimateFsmAction.Calculation[]>();
set => SetField(value);
}
