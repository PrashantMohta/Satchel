...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of Rotate allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class RotateR:InstanceClassWrapper<HutongGames.PlayMaker.Actions.Rotate>
{
public RotateR(HutongGames.PlayMaker.Actions.Rotate _orig) : base(_orig) {}
