...
/// </summary>
public class SteamWindowsNativeProfileR : InstanceClassWrapper<SteamWindowsNativeProfile>
{
    public SteamWindowsNativeProfileR(SteamWindowsNativeProfile _orig) : base(_orig)
    {
    }
