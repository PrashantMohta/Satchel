...
/// <summary>
///     A class that contains all (public and private) fields and methods of MogaProPowerAndroidUnityProfile allowing you
///     to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class MogaProPowerAndroidUnityProfileR : InstanceClassWrapper<MogaProPowerAndroidUnityProfile>
{
    public MogaProPowerAndroidUnityProfileR(MogaProPowerAndroidUnityProfile _orig) : base(_orig)
    {
    }
