...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of SetVelocity allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class SetVelocityR:InstanceClassWrapper<HutongGames.PlayMaker.Actions.SetVelocity>
{
public SetVelocityR(HutongGames.PlayMaker.Actions.SetVelocity _orig) : base(_orig) {}
