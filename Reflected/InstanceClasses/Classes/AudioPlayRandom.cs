...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of AudioPlayRandom allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class AudioPlayRandomR:InstanceClassWrapper<HutongGames.PlayMaker.Actions.AudioPlayRandom>
{
public AudioPlayRandomR(HutongGames.PlayMaker.Actions.AudioPlayRandom _orig) : base(_orig) {}
