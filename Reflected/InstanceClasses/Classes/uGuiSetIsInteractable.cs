...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of uGuiSetIsInteractable allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class uGuiSetIsInteractableR:InstanceClassWrapper<HutongGames.PlayMaker.Actions.uGuiSetIsInteractable>
{
public uGuiSetIsInteractableR(HutongGames.PlayMaker.Actions.uGuiSetIsInteractable _orig) : base(_orig) {}
