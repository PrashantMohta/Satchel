...
/// </summary>
public class iTweenRotateUpdateR:InstanceClassWrapper<HutongGames.PlayMaker.Actions.iTweenRotateUpdate>
{
public iTweenRotateUpdateR(HutongGames.PlayMaker.Actions.iTweenRotateUpdate _orig) : base(_orig) {}
