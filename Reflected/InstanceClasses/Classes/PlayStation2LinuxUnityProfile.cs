...
/// </summary>
public class PlayStation2LinuxUnityProfileR : InstanceClassWrapper<PlayStation2LinuxUnityProfile>
{
    public PlayStation2LinuxUnityProfileR(PlayStation2LinuxUnityProfile _orig) : base(_orig)
    {
    }
