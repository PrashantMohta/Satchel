...
/// <summary>
///     A class that contains all (public and private) fields and methods of EnemyDeathEffectsNoEffect allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class EnemyDeathEffectsNoEffectR : InstanceClassWrapper<EnemyDeathEffectsNoEffect>
{
    public EnemyDeathEffectsNoEffectR(EnemyDeathEffectsNoEffect _orig) : base(_orig)
    {
    }
