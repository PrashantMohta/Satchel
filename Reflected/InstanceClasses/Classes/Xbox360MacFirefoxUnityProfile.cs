...
/// </summary>
public class Xbox360MacFirefoxUnityProfileR : InstanceClassWrapper<Xbox360MacFirefoxUnityProfile>
{
    public Xbox360MacFirefoxUnityProfileR(Xbox360MacFirefoxUnityProfile _orig) : base(_orig)
    {
    }
