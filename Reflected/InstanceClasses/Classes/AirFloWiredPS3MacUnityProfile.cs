...
/// </summary>
public class AirFloWiredPS3MacUnityProfileR : InstanceClassWrapper<AirFloWiredPS3MacUnityProfile>
{
    public AirFloWiredPS3MacUnityProfileR(AirFloWiredPS3MacUnityProfile _orig) : base(_orig)
    {
    }
