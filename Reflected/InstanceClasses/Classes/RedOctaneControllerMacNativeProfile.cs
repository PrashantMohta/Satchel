...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of RedOctaneControllerMacNativeProfile allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class RedOctaneControllerMacNativeProfileR:InstanceClassWrapper<InControl.NativeDeviceProfiles.RedOctaneControllerMacNativeProfile>
{
public RedOctaneControllerMacNativeProfileR(InControl.NativeDeviceProfiles.RedOctaneControllerMacNativeProfile _orig) : base(_orig) {}
