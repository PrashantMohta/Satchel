...
/// </summary>
public class GameSirG4sAndroidUnityProfileR : InstanceClassWrapper<GameSirG4sAndroidUnityProfile>
{
    public GameSirG4sAndroidUnityProfileR(GameSirG4sAndroidUnityProfile _orig) : base(_orig)
    {
    }
