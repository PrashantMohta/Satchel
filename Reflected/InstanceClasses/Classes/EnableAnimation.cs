...
/// </summary>
public class EnableAnimationR : InstanceClassWrapper<EnableAnimation>
{
    public EnableAnimationR(EnableAnimation _orig) : base(_orig)
    {
    }
    ...
    public void DoEnableAnimation(GameObject go)
    {
