...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of GUILayoutFloatField allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class GUILayoutFloatFieldR:InstanceClassWrapper<HutongGames.PlayMaker.Actions.GUILayoutFloatField>
{
public GUILayoutFloatFieldR(HutongGames.PlayMaker.Actions.GUILayoutFloatField _orig) : base(_orig) {}
