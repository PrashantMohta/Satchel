...
/// </summary>
public class SpawnRandomObjectsOverTimeV2R : InstanceClassWrapper<SpawnRandomObjectsOverTimeV2>
{
    public SpawnRandomObjectsOverTimeV2R(SpawnRandomObjectsOverTimeV2 _orig) : base(_orig)
    {
    }
