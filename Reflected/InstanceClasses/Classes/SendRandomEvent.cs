...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of SendRandomEvent allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class SendRandomEventR:InstanceClassWrapper<HutongGames.PlayMaker.Actions.SendRandomEvent>
{
public SendRandomEventR(HutongGames.PlayMaker.Actions.SendRandomEvent _orig) : base(_orig) {}
