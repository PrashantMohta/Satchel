...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of SetIsKinematic2d allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class SetIsKinematic2dR:InstanceClassWrapper<HutongGames.PlayMaker.Actions.SetIsKinematic2d>
{
public SetIsKinematic2dR(HutongGames.PlayMaker.Actions.SetIsKinematic2d _orig) : base(_orig) {}
...
public HutongGames.PlayMaker.FsmBool isKinematic
{
get => orig.isKinematic;
set => orig.isKinematic = value;
}
