...
/// <summary>
///     A class that contains all (public and private) fields and methods of LogitechThunderpadMacNativeProfile allowing
///     you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class LogitechThunderpadMacNativeProfileR : InstanceClassWrapper<LogitechThunderpadMacNativeProfile>
{
    public LogitechThunderpadMacNativeProfileR(LogitechThunderpadMacNativeProfile _orig) : base(_orig)
    {
    }
