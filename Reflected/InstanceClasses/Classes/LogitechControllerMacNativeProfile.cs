...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of LogitechControllerMacNativeProfile allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class LogitechControllerMacNativeProfileR:InstanceClassWrapper<InControl.NativeDeviceProfiles.LogitechControllerMacNativeProfile>
{
public LogitechControllerMacNativeProfileR(InControl.NativeDeviceProfiles.LogitechControllerMacNativeProfile _orig) : base(_orig) {}
