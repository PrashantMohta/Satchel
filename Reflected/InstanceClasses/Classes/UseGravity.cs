...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of UseGravity allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class UseGravityR:InstanceClassWrapper<HutongGames.PlayMaker.Actions.UseGravity>
{
public UseGravityR(HutongGames.PlayMaker.Actions.UseGravity _orig) : base(_orig) {}
...
public HutongGames.PlayMaker.FsmBool useGravity
{
get => orig.useGravity;
set => orig.useGravity = value;
}
