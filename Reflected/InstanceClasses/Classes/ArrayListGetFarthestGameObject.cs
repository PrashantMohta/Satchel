...
/// </summary>
public class ArrayListGetFarthestGameObjectR : InstanceClassWrapper<ArrayListGetFarthestGameObject>
{
    public ArrayListGetFarthestGameObjectR(ArrayListGetFarthestGameObject _orig) : base(_orig)
    {
    }
