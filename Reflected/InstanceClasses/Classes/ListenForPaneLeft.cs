...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of ListenForPaneLeft allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class ListenForPaneLeftR:InstanceClassWrapper<HutongGames.PlayMaker.Actions.ListenForPaneLeft>
{
public ListenForPaneLeftR(HutongGames.PlayMaker.Actions.ListenForPaneLeft _orig) : base(_orig) {}
