...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of ExecutionerXWindowsUnityProfile allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class ExecutionerXWindowsUnityProfileR:InstanceClassWrapper<InControl.UnityDeviceProfiles.ExecutionerXWindowsUnityProfile>
{
public ExecutionerXWindowsUnityProfileR(InControl.UnityDeviceProfiles.ExecutionerXWindowsUnityProfile _orig) : base(_orig) {}
