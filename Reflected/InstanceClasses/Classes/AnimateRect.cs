...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of AnimateRect allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class AnimateRectR:InstanceClassWrapper<HutongGames.PlayMaker.Actions.AnimateRect>
{
public AnimateRectR(HutongGames.PlayMaker.Actions.AnimateRect _orig) : base(_orig) {}
