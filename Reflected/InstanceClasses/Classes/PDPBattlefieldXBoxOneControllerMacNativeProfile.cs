...
///     PDPBattlefieldXBoxOneControllerMacNativeProfile allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class
    PDPBattlefieldXBoxOneControllerMacNativeProfileR : InstanceClassWrapper<
        PDPBattlefieldXBoxOneControllerMacNativeProfile>
{
    public PDPBattlefieldXBoxOneControllerMacNativeProfileR(PDPBattlefieldXBoxOneControllerMacNativeProfile _orig) :
        base(_orig)
    {
    }
