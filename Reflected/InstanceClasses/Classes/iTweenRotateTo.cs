...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of iTweenRotateTo allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class iTweenRotateToR:InstanceClassWrapper<HutongGames.PlayMaker.Actions.iTweenRotateTo>
{
public iTweenRotateToR(HutongGames.PlayMaker.Actions.iTweenRotateTo _orig) : base(_orig) {}
