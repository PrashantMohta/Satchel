...
/// </summary>
public class GetAnimatorRootR:InstanceClassWrapper<HutongGames.PlayMaker.Actions.GetAnimatorRoot>
{
public GetAnimatorRootR(HutongGames.PlayMaker.Actions.GetAnimatorRoot _orig) : base(_orig) {}
...
public HutongGames.PlayMaker.FsmVector3 rootPosition
{
get => orig.rootPosition;
set => orig.rootPosition = value;
}

public HutongGames.PlayMaker.FsmQuaternion rootRotation
{
