...
/// </summary>
public class SetAnimatorStabilizeFeetR : InstanceClassWrapper<SetAnimatorStabilizeFeet>
{
    public SetAnimatorStabilizeFeetR(SetAnimatorStabilizeFeet _orig) : base(_orig)
    {
    }
