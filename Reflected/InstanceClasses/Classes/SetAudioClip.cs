...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of SetAudioClip allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class SetAudioClipR:InstanceClassWrapper<HutongGames.PlayMaker.Actions.SetAudioClip>
{
public SetAudioClipR(HutongGames.PlayMaker.Actions.SetAudioClip _orig) : base(_orig) {}
