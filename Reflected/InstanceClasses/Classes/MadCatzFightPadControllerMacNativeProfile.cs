...
/// <summary>
///     A class that contains all (public and private) fields and methods of MadCatzFightPadControllerMacNativeProfile
///     allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class
    MadCatzFightPadControllerMacNativeProfileR : InstanceClassWrapper<MadCatzFightPadControllerMacNativeProfile>
{
    public MadCatzFightPadControllerMacNativeProfileR(MadCatzFightPadControllerMacNativeProfile _orig) : base(_orig)
    {
    }
