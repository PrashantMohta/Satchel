...
/// <summary>
///     A class that contains all (public and private) fields and methods of MadCatzGhostReconFightingStickMacNativeProfile
///     allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class
    MadCatzGhostReconFightingStickMacNativeProfileR : InstanceClassWrapper<
        MadCatzGhostReconFightingStickMacNativeProfile>
{
    public MadCatzGhostReconFightingStickMacNativeProfileR(MadCatzGhostReconFightingStickMacNativeProfile _orig) :
        base(_orig)
    {
    }
