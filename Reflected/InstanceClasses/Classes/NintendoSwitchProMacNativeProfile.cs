...
/// <summary>
///     A class that contains all (public and private) fields and methods of NintendoSwitchProMacNativeProfile allowing you
///     to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class NintendoSwitchProMacNativeProfileR : InstanceClassWrapper<NintendoSwitchProMacNativeProfile>
{
    public NintendoSwitchProMacNativeProfileR(NintendoSwitchProMacNativeProfile _orig) : base(_orig)
    {
    }
