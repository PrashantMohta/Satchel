...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of NintendoSwitchProMacChromeUnityProfile allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class NintendoSwitchProMacChromeUnityProfileR:InstanceClassWrapper<InControl.UnityDeviceProfiles.NintendoSwitchProMacChromeUnityProfile>
{
public NintendoSwitchProMacChromeUnityProfileR(InControl.UnityDeviceProfiles.NintendoSwitchProMacChromeUnityProfile _orig) : base(_orig) {}
