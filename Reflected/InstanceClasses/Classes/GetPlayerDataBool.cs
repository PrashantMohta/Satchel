...
/// </summary>
public class GetPlayerDataBoolR:InstanceClassWrapper<HutongGames.PlayMaker.Actions.GetPlayerDataBool>
{
public GetPlayerDataBoolR(HutongGames.PlayMaker.Actions.GetPlayerDataBool _orig) : base(_orig) {}
