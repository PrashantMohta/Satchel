...
/// </summary>
public class AmazonFireTVUnityProfileR : InstanceClassWrapper<AmazonFireTVUnityProfile>
{
    public AmazonFireTVUnityProfileR(AmazonFireTVUnityProfile _orig) : base(_orig)
    {
    }
