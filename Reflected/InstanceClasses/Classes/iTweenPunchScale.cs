...
/// </summary>
public class iTweenPunchScaleR:InstanceClassWrapper<HutongGames.PlayMaker.Actions.iTweenPunchScale>
{
public iTweenPunchScaleR(HutongGames.PlayMaker.Actions.iTweenPunchScale _orig) : base(_orig) {}
