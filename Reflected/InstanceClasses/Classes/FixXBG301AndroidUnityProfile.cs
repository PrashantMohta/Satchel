...
/// </summary>
public class FixXBG301AndroidUnityProfileR : InstanceClassWrapper<FixXBG301AndroidUnityProfile>
{
    public FixXBG301AndroidUnityProfileR(FixXBG301AndroidUnityProfile _orig) : base(_orig)
    {
    }
