...
/// <summary>
///     A class that contains all (public and private) fields and methods of ElecomControllerMacNativeProfile allowing you
///     to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class ElecomControllerMacNativeProfileR : InstanceClassWrapper<ElecomControllerMacNativeProfile>
{
    public ElecomControllerMacNativeProfileR(ElecomControllerMacNativeProfile _orig) : base(_orig)
    {
    }
