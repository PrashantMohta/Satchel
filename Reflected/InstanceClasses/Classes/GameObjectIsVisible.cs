...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of GameObjectIsVisible allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class GameObjectIsVisibleR:InstanceClassWrapper<HutongGames.PlayMaker.Actions.GameObjectIsVisible>
{
public GameObjectIsVisibleR(HutongGames.PlayMaker.Actions.GameObjectIsVisible _orig) : base(_orig) {}
