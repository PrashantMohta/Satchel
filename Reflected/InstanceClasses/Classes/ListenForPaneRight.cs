...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of ListenForPaneRight allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class ListenForPaneRightR:InstanceClassWrapper<HutongGames.PlayMaker.Actions.ListenForPaneRight>
{
public ListenForPaneRightR(HutongGames.PlayMaker.Actions.ListenForPaneRight _orig) : base(_orig) {}
