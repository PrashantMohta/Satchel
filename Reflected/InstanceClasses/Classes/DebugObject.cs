...
/// </summary>
public class DebugObjectR:InstanceClassWrapper<HutongGames.PlayMaker.Actions.DebugObject>
{
public DebugObjectR(HutongGames.PlayMaker.Actions.DebugObject _orig) : base(_orig) {}
...
public HutongGames.PlayMaker.FsmObject fsmObject
{
get => orig.fsmObject;
