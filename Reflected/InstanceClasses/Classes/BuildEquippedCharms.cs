...
public UnityEngine.Color notchFullColor
{
get => orig.notchFullColor;
set => orig.notchFullColor = value;
}

public UnityEngine.Color notchOverColor
{
get => orig.notchOverColor;
set => orig.notchOverColor = value;
}

public System.Collections.Generic.List<System.Int32> equippedCharms
{
get => orig.equippedCharms;
set => orig.equippedCharms = value;
}

public System.Collections.Generic.List<UnityEngine.GameObject> gameObjectList
{
get => orig.gameObjectList;
set => orig.gameObjectList = value;
}

public System.Collections.Generic.List<UnityEngine.GameObject> instanceList
{
...
public UnityEngine.GameObject textNotches
{
get => GetField<UnityEngine.GameObject>();
set => SetField(value);
}

public UnityEngine.GameObject nextDot
{
get => orig.nextDot;
set => orig.nextDot = value;
}

public UnityEngine.GameObject charmsFolder
{
...
public UnityEngine.GameObject GetObjectAt (int listNumber) =>
orig.GetObjectAt(listNumber);

public int GetUICount () =>
orig.GetUICount();

public string GetItemName (int itemNum) =>
orig.GetItemName(itemNum);
