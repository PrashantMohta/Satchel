...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of ListenForRsDown allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class ListenForRsDownR:InstanceClassWrapper<HutongGames.PlayMaker.Actions.ListenForRsDown>
{
public ListenForRsDownR(HutongGames.PlayMaker.Actions.ListenForRsDown _orig) : base(_orig) {}
