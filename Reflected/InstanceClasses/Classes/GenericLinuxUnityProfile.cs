...
/// </summary>
public class GenericLinuxUnityProfileR : InstanceClassWrapper<GenericLinuxUnityProfile>
{
    public GenericLinuxUnityProfileR(GenericLinuxUnityProfile _orig) : base(_orig)
    {
    }
