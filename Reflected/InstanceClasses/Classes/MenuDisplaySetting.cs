...
/// </summary>
public class MenuDisplaySettingR:InstanceClassWrapper<UnityEngine.UI.MenuDisplaySetting>
{
public MenuDisplaySettingR(UnityEngine.UI.MenuDisplaySetting _orig) : base(_orig) {}
...
public UnityEngine.Display[] availableDisplays
{
get => GetField<UnityEngine.Display[]>();
set => SetField(value);
}
...
public System.Collections.IEnumerator TargetDisplayHack (int targetDisplay) =>
CallMethod<System.Collections.IEnumerator>(new object[] {targetDisplay});
