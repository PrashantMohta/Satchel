...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of PowerAMiniControllerMacNativeProfile allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class PowerAMiniControllerMacNativeProfileR:InstanceClassWrapper<InControl.NativeDeviceProfiles.PowerAMiniControllerMacNativeProfile>
{
public PowerAMiniControllerMacNativeProfileR(InControl.NativeDeviceProfiles.PowerAMiniControllerMacNativeProfile _orig) : base(_orig) {}
