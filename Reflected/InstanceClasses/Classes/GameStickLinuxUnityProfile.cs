...
/// </summary>
public class GameStickLinuxUnityProfileR : InstanceClassWrapper<GameStickLinuxUnityProfile>
{
    public GameStickLinuxUnityProfileR(GameStickLinuxUnityProfile _orig) : base(_orig)
    {
    }
