...
/// </summary>
public class XboxOneDriverMacNativeProfileR : InstanceClassWrapper<XboxOneDriverMacNativeProfile>
{
    public XboxOneDriverMacNativeProfileR(XboxOneDriverMacNativeProfile _orig) : base(_orig)
    {
    }
