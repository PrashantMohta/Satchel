...
/// </summary>
public class uGuiGraphicGetColorR:InstanceClassWrapper<HutongGames.PlayMaker.Actions.uGuiGraphicGetColor>
{
public uGuiGraphicGetColorR(HutongGames.PlayMaker.Actions.uGuiGraphicGetColor _orig) : base(_orig) {}
