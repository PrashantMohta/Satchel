...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of WakeUp allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class WakeUpR:InstanceClassWrapper<HutongGames.PlayMaker.Actions.WakeUp>
{
public WakeUpR(HutongGames.PlayMaker.Actions.WakeUp _orig) : base(_orig) {}
