...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of EightBitdoSFC30WindowsNativeProfile allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class EightBitdoSFC30WindowsNativeProfileR:InstanceClassWrapper<InControl.NativeDeviceProfiles.EightBitdoSFC30WindowsNativeProfile>
{
public EightBitdoSFC30WindowsNativeProfileR(InControl.NativeDeviceProfiles.EightBitdoSFC30WindowsNativeProfile _orig) : base(_orig) {}
