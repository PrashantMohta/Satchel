...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of RazerOnzaControllerMacNativeProfile allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class RazerOnzaControllerMacNativeProfileR:InstanceClassWrapper<InControl.NativeDeviceProfiles.RazerOnzaControllerMacNativeProfile>
{
public RazerOnzaControllerMacNativeProfileR(InControl.NativeDeviceProfiles.RazerOnzaControllerMacNativeProfile _orig) : base(_orig) {}
