...
/// </summary>
public class OUYAWindowsNativeProfileR : InstanceClassWrapper<OUYAWindowsNativeProfile>
{
    public OUYAWindowsNativeProfileR(OUYAWindowsNativeProfile _orig) : base(_orig)
    {
    }
