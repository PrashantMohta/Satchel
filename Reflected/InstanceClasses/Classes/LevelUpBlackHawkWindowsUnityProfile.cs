...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of LevelUpBlackHawkWindowsUnityProfile allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class LevelUpBlackHawkWindowsUnityProfileR:InstanceClassWrapper<InControl.UnityDeviceProfiles.LevelUpBlackHawkWindowsUnityProfile>
{
public LevelUpBlackHawkWindowsUnityProfileR(InControl.UnityDeviceProfiles.LevelUpBlackHawkWindowsUnityProfile _orig) : base(_orig) {}
