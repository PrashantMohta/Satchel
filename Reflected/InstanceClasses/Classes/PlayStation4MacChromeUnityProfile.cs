...
/// <summary>
///     A class that contains all (public and private) fields and methods of PlayStation4MacChromeUnityProfile allowing you
///     to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class PlayStation4MacChromeUnityProfileR : InstanceClassWrapper<PlayStation4MacChromeUnityProfile>
{
    public PlayStation4MacChromeUnityProfileR(PlayStation4MacChromeUnityProfile _orig) : base(_orig)
    {
    }
