...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of ListenForInventory allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class ListenForInventoryR:InstanceClassWrapper<HutongGames.PlayMaker.Actions.ListenForInventory>
{
public ListenForInventoryR(HutongGames.PlayMaker.Actions.ListenForInventory _orig) : base(_orig) {}
