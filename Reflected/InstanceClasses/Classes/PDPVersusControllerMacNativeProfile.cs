...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of PDPVersusControllerMacNativeProfile allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class PDPVersusControllerMacNativeProfileR:InstanceClassWrapper<InControl.NativeDeviceProfiles.PDPVersusControllerMacNativeProfile>
{
public PDPVersusControllerMacNativeProfileR(InControl.NativeDeviceProfiles.PDPVersusControllerMacNativeProfile _orig) : base(_orig) {}
