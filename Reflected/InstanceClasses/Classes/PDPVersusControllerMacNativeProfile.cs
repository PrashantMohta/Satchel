...
/// <summary>
///     A class that contains all (public and private) fields and methods of PDPVersusControllerMacNativeProfile allowing
///     you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class PDPVersusControllerMacNativeProfileR : InstanceClassWrapper<PDPVersusControllerMacNativeProfile>
{
    public PDPVersusControllerMacNativeProfileR(PDPVersusControllerMacNativeProfile _orig) : base(_orig)
    {
    }
