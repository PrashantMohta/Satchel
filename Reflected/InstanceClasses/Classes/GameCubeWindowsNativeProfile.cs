...
/// </summary>
public class GameCubeWindowsNativeProfileR : InstanceClassWrapper<GameCubeWindowsNativeProfile>
{
    public GameCubeWindowsNativeProfileR(GameCubeWindowsNativeProfile _orig) : base(_orig)
    {
    }
