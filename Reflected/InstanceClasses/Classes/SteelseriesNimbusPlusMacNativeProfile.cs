...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of SteelseriesNimbusPlusMacNativeProfile allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class SteelseriesNimbusPlusMacNativeProfileR:InstanceClassWrapper<InControl.NativeDeviceProfiles.SteelseriesNimbusPlusMacNativeProfile>
{
public SteelseriesNimbusPlusMacNativeProfileR(InControl.NativeDeviceProfiles.SteelseriesNimbusPlusMacNativeProfile _orig) : base(_orig) {}
