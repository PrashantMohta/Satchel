...
/// <summary>
///     A class that contains all (public and private) fields and methods of HoriRealArcadeProVHayabusaMacNativeProfile
///     allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class
    HoriRealArcadeProVHayabusaMacNativeProfileR : InstanceClassWrapper<HoriRealArcadeProVHayabusaMacNativeProfile>
{
    public HoriRealArcadeProVHayabusaMacNativeProfileR(HoriRealArcadeProVHayabusaMacNativeProfile _orig) : base(_orig)
    {
    }
