...
/// </summary>
public class GetMouseButtonUpR:InstanceClassWrapper<HutongGames.PlayMaker.Actions.GetMouseButtonUp>
{
public GetMouseButtonUpR(HutongGames.PlayMaker.Actions.GetMouseButtonUp _orig) : base(_orig) {}
