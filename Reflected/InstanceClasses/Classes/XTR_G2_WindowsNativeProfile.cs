...
/// </summary>
public class XTR_G2_WindowsNativeProfileR : InstanceClassWrapper<XTR_G2_WindowsNativeProfile>
{
    public XTR_G2_WindowsNativeProfileR(XTR_G2_WindowsNativeProfile _orig) : base(_orig)
    {
    }
