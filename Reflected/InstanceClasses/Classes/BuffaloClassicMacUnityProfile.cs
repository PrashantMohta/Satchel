...
/// </summary>
public class BuffaloClassicMacUnityProfileR : InstanceClassWrapper<BuffaloClassicMacUnityProfile>
{
    public BuffaloClassicMacUnityProfileR(BuffaloClassicMacUnityProfile _orig) : base(_orig)
    {
    }
