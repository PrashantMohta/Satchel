...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of ColorInterpolate allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class ColorInterpolateR:InstanceClassWrapper<HutongGames.PlayMaker.Actions.ColorInterpolate>
{
public ColorInterpolateR(HutongGames.PlayMaker.Actions.ColorInterpolate _orig) : base(_orig) {}
