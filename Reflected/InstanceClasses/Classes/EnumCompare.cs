...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of EnumCompare allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class EnumCompareR:InstanceClassWrapper<HutongGames.PlayMaker.Actions.EnumCompare>
{
public EnumCompareR(HutongGames.PlayMaker.Actions.EnumCompare _orig) : base(_orig) {}
