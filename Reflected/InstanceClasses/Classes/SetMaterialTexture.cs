...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of SetMaterialTexture allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class SetMaterialTextureR:InstanceClassWrapper<HutongGames.PlayMaker.Actions.SetMaterialTexture>
{
public SetMaterialTextureR(HutongGames.PlayMaker.Actions.SetMaterialTexture _orig) : base(_orig) {}
...
public void DoSetMaterialTexture () =>
CallMethod();
