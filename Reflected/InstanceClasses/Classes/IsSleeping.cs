...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of IsSleeping allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class IsSleepingR:InstanceClassWrapper<HutongGames.PlayMaker.Actions.IsSleeping>
{
public IsSleepingR(HutongGames.PlayMaker.Actions.IsSleeping _orig) : base(_orig) {}
