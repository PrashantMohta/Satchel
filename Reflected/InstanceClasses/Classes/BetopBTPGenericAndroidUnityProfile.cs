...
/// <summary>
///     A class that contains all (public and private) fields and methods of BetopBTPGenericAndroidUnityProfile allowing
///     you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class BetopBTPGenericAndroidUnityProfileR : InstanceClassWrapper<BetopBTPGenericAndroidUnityProfile>
{
    public BetopBTPGenericAndroidUnityProfileR(BetopBTPGenericAndroidUnityProfile _orig) : base(_orig)
    {
    }
