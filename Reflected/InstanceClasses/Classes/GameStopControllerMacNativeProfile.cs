...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of GameStopControllerMacNativeProfile allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class GameStopControllerMacNativeProfileR:InstanceClassWrapper<InControl.NativeDeviceProfiles.GameStopControllerMacNativeProfile>
{
public GameStopControllerMacNativeProfileR(InControl.NativeDeviceProfiles.GameStopControllerMacNativeProfile _orig) : base(_orig) {}
