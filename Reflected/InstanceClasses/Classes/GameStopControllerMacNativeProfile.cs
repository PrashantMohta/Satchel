...
/// <summary>
///     A class that contains all (public and private) fields and methods of GameStopControllerMacNativeProfile allowing
///     you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class GameStopControllerMacNativeProfileR : InstanceClassWrapper<GameStopControllerMacNativeProfile>
{
    public GameStopControllerMacNativeProfileR(GameStopControllerMacNativeProfile _orig) : base(_orig)
    {
    }
