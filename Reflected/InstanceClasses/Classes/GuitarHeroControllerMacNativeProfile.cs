...
/// <summary>
///     A class that contains all (public and private) fields and methods of GuitarHeroControllerMacNativeProfile allowing
///     you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class GuitarHeroControllerMacNativeProfileR : InstanceClassWrapper<GuitarHeroControllerMacNativeProfile>
{
    public GuitarHeroControllerMacNativeProfileR(GuitarHeroControllerMacNativeProfile _orig) : base(_orig)
    {
    }
