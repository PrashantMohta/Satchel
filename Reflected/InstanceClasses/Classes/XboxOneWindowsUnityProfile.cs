...
/// </summary>
public class XboxOneWindowsUnityProfileR : InstanceClassWrapper<XboxOneWindowsUnityProfile>
{
    public XboxOneWindowsUnityProfileR(XboxOneWindowsUnityProfile _orig) : base(_orig)
    {
    }
