...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of ArrayListSendEventToGameObjects allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class ArrayListSendEventToGameObjectsR:InstanceClassWrapper<HutongGames.PlayMaker.Actions.ArrayListSendEventToGameObjects>
{
public ArrayListSendEventToGameObjectsR(HutongGames.PlayMaker.Actions.ArrayListSendEventToGameObjects _orig) : base(_orig) {}
...
public void sendEventToGO (UnityEngine.GameObject _go) =>
CallMethod(new object[] {_go});
