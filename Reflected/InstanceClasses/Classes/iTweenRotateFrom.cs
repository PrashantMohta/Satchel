...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of iTweenRotateFrom allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class iTweenRotateFromR:InstanceClassWrapper<HutongGames.PlayMaker.Actions.iTweenRotateFrom>
{
public iTweenRotateFromR(HutongGames.PlayMaker.Actions.iTweenRotateFrom _orig) : base(_orig) {}
...
public HutongGames.PlayMaker.FsmGameObject transformRotation
{
get => orig.transformRotation;
set => orig.transformRotation = value;
}

public HutongGames.PlayMaker.FsmVector3 vectorRotation
{
