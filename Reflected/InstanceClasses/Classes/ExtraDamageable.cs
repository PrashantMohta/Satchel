...
public HutongGames.PlayMaker.FsmBool invincibleVar
{
get => GetField<HutongGames.PlayMaker.FsmBool>();
set => SetField(value);
}

public HutongGames.PlayMaker.FsmInt hpVar
{
get => GetField<HutongGames.PlayMaker.FsmInt>();
set => SetField(value);
}
...
ExtraDamageable.GetDamageOfType(extraDamageTypes);
