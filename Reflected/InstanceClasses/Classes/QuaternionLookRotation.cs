...
/// </summary>
public class QuaternionLookRotationR : InstanceClassWrapper<QuaternionLookRotation>
{
    public QuaternionLookRotationR(QuaternionLookRotation _orig) : base(_orig)
    {
    }
