...
/// </summary>
public class IdleBuzzV2R:InstanceClassWrapper<HutongGames.PlayMaker.Actions.IdleBuzzV2>
{
public IdleBuzzV2R(HutongGames.PlayMaker.Actions.IdleBuzzV2 _orig) : base(_orig) {}
