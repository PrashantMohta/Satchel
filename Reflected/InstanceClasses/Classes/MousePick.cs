...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of MousePick allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class MousePickR:InstanceClassWrapper<HutongGames.PlayMaker.Actions.MousePick>
{
public MousePickR(HutongGames.PlayMaker.Actions.MousePick _orig) : base(_orig) {}
