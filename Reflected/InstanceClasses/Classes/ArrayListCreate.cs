...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of ArrayListCreate allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class ArrayListCreateR:InstanceClassWrapper<HutongGames.PlayMaker.Actions.ArrayListCreate>
{
public ArrayListCreateR(HutongGames.PlayMaker.Actions.ArrayListCreate _orig) : base(_orig) {}
