...
/// <summary>
///     A class that contains all (public and private) fields and methods of AirFloControllerMacNativeProfile allowing you
///     to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class AirFloControllerMacNativeProfileR : InstanceClassWrapper<AirFloControllerMacNativeProfile>
{
    public AirFloControllerMacNativeProfileR(AirFloControllerMacNativeProfile _orig) : base(_orig)
    {
    }
