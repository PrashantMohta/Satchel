...
/// </summary>
public class ArrayListGetMaxValueR : InstanceClassWrapper<ArrayListGetMaxValue>
{
    public ArrayListGetMaxValueR(ArrayListGetMaxValue _orig) : base(_orig)
    {
    }

    public VariableType[] supportedTypes
    {
        get => GetFieldStatic<VariableType[]>();
        set => SetField(value);
    }
