...
/// <summary>
///     A class that contains all (public and private) fields and methods of MicrosoftAdaptiveControllerMacNativeProfile
///     allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class
    MicrosoftAdaptiveControllerMacNativeProfileR : InstanceClassWrapper<MicrosoftAdaptiveControllerMacNativeProfile>
{
    public MicrosoftAdaptiveControllerMacNativeProfileR(MicrosoftAdaptiveControllerMacNativeProfile _orig) : base(_orig)
    {
    }
