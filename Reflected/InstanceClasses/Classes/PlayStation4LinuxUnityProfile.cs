...
/// </summary>
public class PlayStation4LinuxUnityProfileR : InstanceClassWrapper<PlayStation4LinuxUnityProfile>
{
    public PlayStation4LinuxUnityProfileR(PlayStation4LinuxUnityProfile _orig) : base(_orig)
    {
    }
