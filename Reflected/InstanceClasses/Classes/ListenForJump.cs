...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of ListenForJump allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class ListenForJumpR:InstanceClassWrapper<HutongGames.PlayMaker.Actions.ListenForJump>
{
public ListenForJumpR(HutongGames.PlayMaker.Actions.ListenForJump _orig) : base(_orig) {}
