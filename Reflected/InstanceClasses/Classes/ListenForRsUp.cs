...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of ListenForRsUp allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class ListenForRsUpR:InstanceClassWrapper<HutongGames.PlayMaker.Actions.ListenForRsUp>
{
public ListenForRsUpR(HutongGames.PlayMaker.Actions.ListenForRsUp _orig) : base(_orig) {}
