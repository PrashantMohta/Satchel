...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of GetFsmBool allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class GetFsmBoolR:InstanceClassWrapper<HutongGames.PlayMaker.Actions.GetFsmBool>
{
public GetFsmBoolR(HutongGames.PlayMaker.Actions.GetFsmBool _orig) : base(_orig) {}
