...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of NexusPlayerMacUnityProfile allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class NexusPlayerMacUnityProfileR:InstanceClassWrapper<InControl.UnityDeviceProfiles.NexusPlayerMacUnityProfile>
{
public NexusPlayerMacUnityProfileR(InControl.UnityDeviceProfiles.NexusPlayerMacUnityProfile _orig) : base(_orig) {}
