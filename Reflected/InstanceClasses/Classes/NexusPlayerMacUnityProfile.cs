...
/// </summary>
public class NexusPlayerMacUnityProfileR : InstanceClassWrapper<NexusPlayerMacUnityProfile>
{
    public NexusPlayerMacUnityProfileR(NexusPlayerMacUnityProfile _orig) : base(_orig)
    {
    }
