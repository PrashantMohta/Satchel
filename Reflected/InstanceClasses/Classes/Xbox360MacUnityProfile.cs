...
/// </summary>
public class Xbox360MacUnityProfileR : InstanceClassWrapper<Xbox360MacUnityProfile>
{
    public Xbox360MacUnityProfileR(Xbox360MacUnityProfile _orig) : base(_orig)
    {
    }
