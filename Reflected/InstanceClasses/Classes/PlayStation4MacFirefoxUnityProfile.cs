...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of PlayStation4MacFirefoxUnityProfile allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class PlayStation4MacFirefoxUnityProfileR:InstanceClassWrapper<InControl.UnityDeviceProfiles.PlayStation4MacFirefoxUnityProfile>
{
public PlayStation4MacFirefoxUnityProfileR(InControl.UnityDeviceProfiles.PlayStation4MacFirefoxUnityProfile _orig) : base(_orig) {}
