...
/// <summary>
///     A class that contains all (public and private) fields and methods of PowerANintendoSwitchMacNativeProfile allowing
///     you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class PowerANintendoSwitchMacNativeProfileR : InstanceClassWrapper<PowerANintendoSwitchMacNativeProfile>
{
    public PowerANintendoSwitchMacNativeProfileR(PowerANintendoSwitchMacNativeProfile _orig) : base(_orig)
    {
    }
