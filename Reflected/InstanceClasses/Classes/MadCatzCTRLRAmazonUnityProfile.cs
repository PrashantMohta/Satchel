...
/// </summary>
public class MadCatzCTRLRAmazonUnityProfileR : InstanceClassWrapper<MadCatzCTRLRAmazonUnityProfile>
{
    public MadCatzCTRLRAmazonUnityProfileR(MadCatzCTRLRAmazonUnityProfile _orig) : base(_orig)
    {
    }
