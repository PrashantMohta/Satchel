...
/// </summary>
public class LogitechF310LinuxUnityProfileR : InstanceClassWrapper<LogitechF310LinuxUnityProfile>
{
    public LogitechF310LinuxUnityProfileR(LogitechF310LinuxUnityProfile _orig) : base(_orig)
    {
    }
