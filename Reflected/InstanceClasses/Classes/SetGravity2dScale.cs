...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of SetGravity2dScale allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class SetGravity2dScaleR:InstanceClassWrapper<HutongGames.PlayMaker.Actions.SetGravity2dScale>
{
public SetGravity2dScaleR(HutongGames.PlayMaker.Actions.SetGravity2dScale _orig) : base(_orig) {}
...
public HutongGames.PlayMaker.FsmFloat gravityScale
{
get => orig.gravityScale;
set => orig.gravityScale = value;
}
