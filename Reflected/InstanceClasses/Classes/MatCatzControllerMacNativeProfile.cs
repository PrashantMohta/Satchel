...
/// <summary>
///     A class that contains all (public and private) fields and methods of MatCatzControllerMacNativeProfile allowing you
///     to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class MatCatzControllerMacNativeProfileR : InstanceClassWrapper<MatCatzControllerMacNativeProfile>
{
    public MatCatzControllerMacNativeProfileR(MatCatzControllerMacNativeProfile _orig) : base(_orig)
    {
    }
