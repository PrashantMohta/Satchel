...
/// </summary>
public class GUIVerticalSliderR:InstanceClassWrapper<HutongGames.PlayMaker.Actions.GUIVerticalSlider>
{
public GUIVerticalSliderR(HutongGames.PlayMaker.Actions.GUIVerticalSlider _orig) : base(_orig) {}
