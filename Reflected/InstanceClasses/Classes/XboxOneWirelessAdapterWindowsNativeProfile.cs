...
/// <summary>
///     A class that contains all (public and private) fields and methods of XboxOneWirelessAdapterWindowsNativeProfile
///     allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class
    XboxOneWirelessAdapterWindowsNativeProfileR : InstanceClassWrapper<XboxOneWirelessAdapterWindowsNativeProfile>
{
    public XboxOneWirelessAdapterWindowsNativeProfileR(XboxOneWirelessAdapterWindowsNativeProfile _orig) : base(_orig)
    {
    }
