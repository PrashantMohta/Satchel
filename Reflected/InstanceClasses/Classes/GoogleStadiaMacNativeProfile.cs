...
/// </summary>
public class GoogleStadiaMacNativeProfileR : InstanceClassWrapper<GoogleStadiaMacNativeProfile>
{
    public GoogleStadiaMacNativeProfileR(GoogleStadiaMacNativeProfile _orig) : base(_orig)
    {
    }
