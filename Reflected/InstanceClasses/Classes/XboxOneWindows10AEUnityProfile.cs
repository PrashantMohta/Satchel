...
/// </summary>
public class XboxOneWindows10AEUnityProfileR : InstanceClassWrapper<XboxOneWindows10AEUnityProfile>
{
    public XboxOneWindows10AEUnityProfileR(XboxOneWindows10AEUnityProfile _orig) : base(_orig)
    {
    }
