...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of GetAudioVolume allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class GetAudioVolumeR:InstanceClassWrapper<HutongGames.PlayMaker.Actions.GetAudioVolume>
{
public GetAudioVolumeR(HutongGames.PlayMaker.Actions.GetAudioVolume _orig) : base(_orig) {}
...
public HutongGames.PlayMaker.FsmFloat storeVolume
{
get => orig.storeVolume;
set => orig.storeVolume = value;
}
