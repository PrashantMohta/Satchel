...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of EightBitdoSNES30WindowsUnityProfile allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class EightBitdoSNES30WindowsUnityProfileR:InstanceClassWrapper<InControl.UnityDeviceProfiles.EightBitdoSNES30WindowsUnityProfile>
{
public EightBitdoSNES30WindowsUnityProfileR(InControl.UnityDeviceProfiles.EightBitdoSNES30WindowsUnityProfile _orig) : base(_orig) {}
