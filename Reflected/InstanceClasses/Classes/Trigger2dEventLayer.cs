...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of Trigger2dEventLayer allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class Trigger2dEventLayerR:InstanceClassWrapper<HutongGames.PlayMaker.Actions.Trigger2dEventLayer>
{
public Trigger2dEventLayerR(HutongGames.PlayMaker.Actions.Trigger2dEventLayer _orig) : base(_orig) {}
