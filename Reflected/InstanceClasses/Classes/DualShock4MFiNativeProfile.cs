...
/// </summary>
public class DualShock4MFiNativeProfileR : InstanceClassWrapper<DualShock4MFiNativeProfile>
{
    public DualShock4MFiNativeProfileR(DualShock4MFiNativeProfile _orig) : base(_orig)
    {
    }
