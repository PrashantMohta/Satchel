...
/// </summary>
public class MLGControllerMacNativeProfileR : InstanceClassWrapper<MLGControllerMacNativeProfile>
{
    public MLGControllerMacNativeProfileR(MLGControllerMacNativeProfile _orig) : base(_orig)
    {
    }
