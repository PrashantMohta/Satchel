...
/// <summary>
///     A class that contains all (public and private) fields and methods of MogaHeroPowerAndroidUnityProfile allowing you
///     to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class MogaHeroPowerAndroidUnityProfileR : InstanceClassWrapper<MogaHeroPowerAndroidUnityProfile>
{
    public MogaHeroPowerAndroidUnityProfileR(MogaHeroPowerAndroidUnityProfile _orig) : base(_orig)
    {
    }
