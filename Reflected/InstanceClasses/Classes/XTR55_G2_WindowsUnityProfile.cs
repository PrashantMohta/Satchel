...
/// </summary>
public class XTR55_G2_WindowsUnityProfileR : InstanceClassWrapper<XTR55_G2_WindowsUnityProfile>
{
    public XTR55_G2_WindowsUnityProfileR(XTR55_G2_WindowsUnityProfile _orig) : base(_orig)
    {
    }
