...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of iTweenScaleTo allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class iTweenScaleToR:InstanceClassWrapper<HutongGames.PlayMaker.Actions.iTweenScaleTo>
{
public iTweenScaleToR(HutongGames.PlayMaker.Actions.iTweenScaleTo _orig) : base(_orig) {}
