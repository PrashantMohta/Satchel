...
/// </summary>
public class IpegaPG9055AndroidUnityProfileR : InstanceClassWrapper<IpegaPG9055AndroidUnityProfile>
{
    public IpegaPG9055AndroidUnityProfileR(IpegaPG9055AndroidUnityProfile _orig) : base(_orig)
    {
    }
