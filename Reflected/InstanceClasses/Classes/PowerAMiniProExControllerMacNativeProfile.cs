...
/// <summary>
///     A class that contains all (public and private) fields and methods of PowerAMiniProExControllerMacNativeProfile
///     allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class
    PowerAMiniProExControllerMacNativeProfileR : InstanceClassWrapper<PowerAMiniProExControllerMacNativeProfile>
{
    public PowerAMiniProExControllerMacNativeProfileR(PowerAMiniProExControllerMacNativeProfile _orig) : base(_orig)
    {
    }
