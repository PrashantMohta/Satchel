...
/// </summary>
public class Xbox360MacSafariUnityProfileR : InstanceClassWrapper<Xbox360MacSafariUnityProfile>
{
    public Xbox360MacSafariUnityProfileR(Xbox360MacSafariUnityProfile _orig) : base(_orig)
    {
    }
