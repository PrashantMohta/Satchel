...
///     HoriRealArcadeProVKaiFightingStickMacNativeProfile allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class
    HoriRealArcadeProVKaiFightingStickMacNativeProfileR : InstanceClassWrapper<
        HoriRealArcadeProVKaiFightingStickMacNativeProfile>
{
    public HoriRealArcadeProVKaiFightingStickMacNativeProfileR(HoriRealArcadeProVKaiFightingStickMacNativeProfile _orig)
        : base(_orig)
    {
    }
