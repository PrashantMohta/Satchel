...
/// </summary>
public class Tk2dTextMeshGetPropertiesR : InstanceClassWrapper<Tk2dTextMeshGetProperties>
{
    public Tk2dTextMeshGetPropertiesR(Tk2dTextMeshGetProperties _orig) : base(_orig)
    {
    }
