...
/// </summary>
public class SetAnimationSpeedR : InstanceClassWrapper<SetAnimationSpeed>
{
    public SetAnimationSpeedR(SetAnimationSpeed _orig) : base(_orig)
    {
    }
    ...
    public void DoSetAnimationSpeed(GameObject go)
    {
