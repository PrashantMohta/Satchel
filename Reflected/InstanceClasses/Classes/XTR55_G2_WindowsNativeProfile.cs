...
/// </summary>
public class XTR55_G2_WindowsNativeProfileR : InstanceClassWrapper<XTR55_G2_WindowsNativeProfile>
{
    public XTR55_G2_WindowsNativeProfileR(XTR55_G2_WindowsNativeProfile _orig) : base(_orig)
    {
    }
