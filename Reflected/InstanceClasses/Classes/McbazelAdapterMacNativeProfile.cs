...
/// </summary>
public class McbazelAdapterMacNativeProfileR : InstanceClassWrapper<McbazelAdapterMacNativeProfile>
{
    public McbazelAdapterMacNativeProfileR(McbazelAdapterMacNativeProfile _orig) : base(_orig)
    {
    }
