...
/// </summary>
public class PauseMenuButtonR:InstanceClassWrapper<UnityEngine.UI.PauseMenuButton>
{
public PauseMenuButtonR(UnityEngine.UI.PauseMenuButton _orig) : base(_orig) {}
