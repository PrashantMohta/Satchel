...
/// </summary>
public class Trigger2dEventToParentR:InstanceClassWrapper<HutongGames.PlayMaker.Actions.Trigger2dEventToParent>
{
public Trigger2dEventToParentR(HutongGames.PlayMaker.Actions.Trigger2dEventToParent _orig) : base(_orig) {}
