...
/// </summary>
public class FlareAndroidUnityProfileR : InstanceClassWrapper<FlareAndroidUnityProfile>
{
    public FlareAndroidUnityProfileR(FlareAndroidUnityProfile _orig) : base(_orig)
    {
    }
