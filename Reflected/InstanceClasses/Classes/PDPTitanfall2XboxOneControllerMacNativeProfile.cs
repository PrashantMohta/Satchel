...
/// <summary>
///     A class that contains all (public and private) fields and methods of PDPTitanfall2XboxOneControllerMacNativeProfile
///     allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class
    PDPTitanfall2XboxOneControllerMacNativeProfileR : InstanceClassWrapper<
        PDPTitanfall2XboxOneControllerMacNativeProfile>
{
    public PDPTitanfall2XboxOneControllerMacNativeProfileR(PDPTitanfall2XboxOneControllerMacNativeProfile _orig) :
        base(_orig)
    {
    }
