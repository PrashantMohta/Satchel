...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of ListenForAttack allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class ListenForAttackR:InstanceClassWrapper<HutongGames.PlayMaker.Actions.ListenForAttack>
{
public ListenForAttackR(HutongGames.PlayMaker.Actions.ListenForAttack _orig) : base(_orig) {}
