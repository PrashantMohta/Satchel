...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of AirFloWiredPS3WindowsUnityProfile allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class AirFloWiredPS3WindowsUnityProfileR:InstanceClassWrapper<InControl.UnityDeviceProfiles.AirFloWiredPS3WindowsUnityProfile>
{
public AirFloWiredPS3WindowsUnityProfileR(InControl.UnityDeviceProfiles.AirFloWiredPS3WindowsUnityProfile _orig) : base(_orig) {}
