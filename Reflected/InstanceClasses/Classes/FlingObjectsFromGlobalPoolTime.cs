...
/// </summary>
public class FlingObjectsFromGlobalPoolTimeR : InstanceClassWrapper<FlingObjectsFromGlobalPoolTime>
{
    public FlingObjectsFromGlobalPoolTimeR(FlingObjectsFromGlobalPoolTime _orig) : base(_orig)
    {
    }
