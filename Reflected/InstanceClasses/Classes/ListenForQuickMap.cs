...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of ListenForQuickMap allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class ListenForQuickMapR:InstanceClassWrapper<HutongGames.PlayMaker.Actions.ListenForQuickMap>
{
public ListenForQuickMapR(HutongGames.PlayMaker.Actions.ListenForQuickMap _orig) : base(_orig) {}
