...
/// <summary>
///     A class that contains all (public and private) fields and methods of AndroidTVMiBoxRemoteUnityProfile allowing you
///     to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class AndroidTVMiBoxRemoteUnityProfileR : InstanceClassWrapper<AndroidTVMiBoxRemoteUnityProfile>
{
    public AndroidTVMiBoxRemoteUnityProfileR(AndroidTVMiBoxRemoteUnityProfile _orig) : base(_orig)
    {
    }
