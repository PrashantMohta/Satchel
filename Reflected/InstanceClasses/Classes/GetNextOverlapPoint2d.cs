...
/// </summary>
public class GetNextOverlapPoint2dR : InstanceClassWrapper<GetNextOverlapPoint2d>
{
    public GetNextOverlapPoint2dR(GetNextOverlapPoint2d _orig) : base(_orig)
    {
    }
    ...
    public Collider2D[] GetOverlapPointAll()
    {
