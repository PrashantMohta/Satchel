...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of MadCatzMicroCTRLRAmazonUnityProfile allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class MadCatzMicroCTRLRAmazonUnityProfileR:InstanceClassWrapper<InControl.UnityDeviceProfiles.MadCatzMicroCTRLRAmazonUnityProfile>
{
public MadCatzMicroCTRLRAmazonUnityProfileR(InControl.UnityDeviceProfiles.MadCatzMicroCTRLRAmazonUnityProfile _orig) : base(_orig) {}
