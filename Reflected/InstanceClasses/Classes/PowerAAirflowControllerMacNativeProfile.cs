...
/// <summary>
///     A class that contains all (public and private) fields and methods of PowerAAirflowControllerMacNativeProfile
///     allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class PowerAAirflowControllerMacNativeProfileR : InstanceClassWrapper<PowerAAirflowControllerMacNativeProfile>
{
    public PowerAAirflowControllerMacNativeProfileR(PowerAAirflowControllerMacNativeProfile _orig) : base(_orig)
    {
    }
