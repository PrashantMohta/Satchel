...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of ListenForDown allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class ListenForDownR:InstanceClassWrapper<HutongGames.PlayMaker.Actions.ListenForDown>
{
public ListenForDownR(HutongGames.PlayMaker.Actions.ListenForDown _orig) : base(_orig) {}
