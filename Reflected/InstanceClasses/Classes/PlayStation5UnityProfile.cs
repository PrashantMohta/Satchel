...
/// </summary>
public class PlayStation5UnityProfileR : InstanceClassWrapper<PlayStation5UnityProfile>
{
    public PlayStation5UnityProfileR(PlayStation5UnityProfile _orig) : base(_orig)
    {
    }
