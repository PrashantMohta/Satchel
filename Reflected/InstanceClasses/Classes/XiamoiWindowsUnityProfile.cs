...
/// </summary>
public class XiamoiWindowsUnityProfileR:InstanceClassWrapper<InControl.UnityDeviceProfiles.XiamoiWindowsUnityProfile>
{
public XiamoiWindowsUnityProfileR(InControl.UnityDeviceProfiles.XiamoiWindowsUnityProfile _orig) : base(_orig) {}
