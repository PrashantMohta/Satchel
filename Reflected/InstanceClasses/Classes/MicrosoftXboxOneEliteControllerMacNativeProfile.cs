...
///     MicrosoftXboxOneEliteControllerMacNativeProfile allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class
    MicrosoftXboxOneEliteControllerMacNativeProfileR : InstanceClassWrapper<
        MicrosoftXboxOneEliteControllerMacNativeProfile>
{
    public MicrosoftXboxOneEliteControllerMacNativeProfileR(MicrosoftXboxOneEliteControllerMacNativeProfile _orig) :
        base(_orig)
    {
    }
