...
/// </summary>
public class Tk2dPlayAnimationWithEventsR : InstanceClassWrapper<Tk2dPlayAnimationWithEvents>
{
    public Tk2dPlayAnimationWithEventsR(Tk2dPlayAnimationWithEvents _orig) : base(_orig)
    {
    }
