...
/// </summary>
public class uGuiInputFieldSetPlaceHolderR : InstanceClassWrapper<uGuiInputFieldSetPlaceHolder>
{
    public uGuiInputFieldSetPlaceHolderR(uGuiInputFieldSetPlaceHolder _orig) : base(_orig)
    {
    }
