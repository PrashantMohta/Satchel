...
/// <summary>
///     A class that contains all (public and private) fields and methods of RockCandyXboxOneControllerMacNativeProfile
///     allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class
    RockCandyXboxOneControllerMacNativeProfileR : InstanceClassWrapper<RockCandyXboxOneControllerMacNativeProfile>
{
    public RockCandyXboxOneControllerMacNativeProfileR(RockCandyXboxOneControllerMacNativeProfile _orig) : base(_orig)
    {
    }
