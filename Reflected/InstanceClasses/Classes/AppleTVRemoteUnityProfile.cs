...
/// </summary>
public class AppleTVRemoteUnityProfileR : InstanceClassWrapper<AppleTVRemoteUnityProfile>
{
    public AppleTVRemoteUnityProfileR(AppleTVRemoteUnityProfile _orig) : base(_orig)
    {
    }
