...
/// </summary>
public class XTR_G2_MacUnityProfileR : InstanceClassWrapper<XTR_G2_MacUnityProfile>
{
    public XTR_G2_MacUnityProfileR(XTR_G2_MacUnityProfile _orig) : base(_orig)
    {
    }
