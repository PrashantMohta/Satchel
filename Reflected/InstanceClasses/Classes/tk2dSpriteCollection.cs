...
public UnityEngine.Texture2D[] textureRefs
{
...
public System.Collections.Generic.List<tk2dSpriteCollectionPlatform> platforms
{
get => orig.platforms;
...
public UnityEngine.Material[] altMaterials
{
get => orig.altMaterials;
set => orig.altMaterials = value;
}

public UnityEngine.Material[] atlasMaterials
{
get => orig.atlasMaterials;
set => orig.atlasMaterials = value;
}

public UnityEngine.Texture2D[] atlasTextures
{
get => orig.atlasTextures;
set => orig.atlasTextures = value;
}

public UnityEngine.TextAsset[] atlasTextureFiles
{
...
public System.Collections.Generic.List<tk2dSpriteCollection.AttachPointTestSprite> attachPointTestSprites
{
...
public System.Collections.Generic.List<tk2dLinkedSpriteCollection> linkedSpriteCollections
{
get => orig.linkedSpriteCollections;
set => orig.linkedSpriteCollections = value;
}

public UnityEngine.Texture2D[] DoNotUse__TextureRefs
{
