...
/// <summary>
///     A class that contains all (public and private) fields and methods of TSZPelicanControllerMacNativeProfile allowing
///     you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class TSZPelicanControllerMacNativeProfileR : InstanceClassWrapper<TSZPelicanControllerMacNativeProfile>
{
    public TSZPelicanControllerMacNativeProfileR(TSZPelicanControllerMacNativeProfile _orig) : base(_orig)
    {
    }
