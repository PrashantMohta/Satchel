...
/// <summary>
///     A class that contains all (public and private) fields and methods of ThrustmasterGPXControllerMacNativeProfile
///     allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class
    ThrustmasterGPXControllerMacNativeProfileR : InstanceClassWrapper<ThrustmasterGPXControllerMacNativeProfile>
{
    public ThrustmasterGPXControllerMacNativeProfileR(ThrustmasterGPXControllerMacNativeProfile _orig) : base(_orig)
    {
    }
