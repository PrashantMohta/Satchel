...
/// </summary>
public class GetAnimatorGravityWeightR : InstanceClassWrapper<GetAnimatorGravityWeight>
{
    public GetAnimatorGravityWeightR(GetAnimatorGravityWeight _orig) : base(_orig)
    {
    }
