...
/// <summary>
///     A class that contains all (public and private) fields and methods of HoriRealArcadeProHayabusaMacNativeProfile
///     allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class
    HoriRealArcadeProHayabusaMacNativeProfileR : InstanceClassWrapper<HoriRealArcadeProHayabusaMacNativeProfile>
{
    public HoriRealArcadeProHayabusaMacNativeProfileR(HoriRealArcadeProHayabusaMacNativeProfile _orig) : base(_orig)
    {
    }
