...
/// </summary>
public class PlayStation4MacNativeProfileR : InstanceClassWrapper<PlayStation4MacNativeProfile>
{
    public PlayStation4MacNativeProfileR(PlayStation4MacNativeProfile _orig) : base(_orig)
    {
    }
