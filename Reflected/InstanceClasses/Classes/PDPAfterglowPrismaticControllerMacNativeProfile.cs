...
///     PDPAfterglowPrismaticControllerMacNativeProfile allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class
    PDPAfterglowPrismaticControllerMacNativeProfileR : InstanceClassWrapper<
        PDPAfterglowPrismaticControllerMacNativeProfile>
{
    public PDPAfterglowPrismaticControllerMacNativeProfileR(PDPAfterglowPrismaticControllerMacNativeProfile _orig) :
        base(_orig)
    {
    }
