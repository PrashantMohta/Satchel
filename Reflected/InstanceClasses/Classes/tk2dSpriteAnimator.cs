...
public class tk2dSpriteAnimatorR : InstanceClassWrapper<tk2dSpriteAnimator>
{
    ...
    public float DefaultFps => tk2dSpriteAnimator.DefaultFps;
    ...
    public tk2dSpriteAnimator AddComponent(GameObject go, tk2dSpriteAnimation anim, int clipId)
    {
        return tk2dSpriteAnimator.AddComponent(go, anim, clipId);
    }

    public tk2dSpriteAnimationClip GetClipByNameVerbose(string name)
    {
        return CallMethod<tk2dSpriteAnimationClip>(new object[] { name });
    }
