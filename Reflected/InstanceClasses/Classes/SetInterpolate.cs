...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of SetInterpolate allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class SetInterpolateR:InstanceClassWrapper<HutongGames.PlayMaker.Actions.SetInterpolate>
{
public SetInterpolateR(HutongGames.PlayMaker.Actions.SetInterpolate _orig) : base(_orig) {}
