...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of ArdwiinoControllerMacNativeProfile allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class ArdwiinoControllerMacNativeProfileR:InstanceClassWrapper<InControl.NativeDeviceProfiles.ArdwiinoControllerMacNativeProfile>
{
public ArdwiinoControllerMacNativeProfileR(InControl.NativeDeviceProfiles.ArdwiinoControllerMacNativeProfile _orig) : base(_orig) {}
