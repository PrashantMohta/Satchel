...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of ArrayListIndexOf allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class ArrayListIndexOfR:InstanceClassWrapper<HutongGames.PlayMaker.Actions.ArrayListIndexOf>
{
public ArrayListIndexOfR(HutongGames.PlayMaker.Actions.ArrayListIndexOf _orig) : base(_orig) {}
...
public HutongGames.PlayMaker.FsmInt indexOf
{
get => orig.indexOf;
set => orig.indexOf = value;
}
