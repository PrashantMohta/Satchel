...
/// </summary>
public class PlayStationVitaPSMUnityProfileR : InstanceClassWrapper<PlayStationVitaPSMUnityProfile>
{
    public PlayStationVitaPSMUnityProfileR(PlayStationVitaPSMUnityProfile _orig) : base(_orig)
    {
    }
