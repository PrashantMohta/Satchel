...
/// </summary>
public class ConvertBoolToStringR:InstanceClassWrapper<HutongGames.PlayMaker.Actions.ConvertBoolToString>
{
public ConvertBoolToStringR(HutongGames.PlayMaker.Actions.ConvertBoolToString _orig) : base(_orig) {}
...
public HutongGames.PlayMaker.FsmString falseString
{
get => orig.falseString;
set => orig.falseString = value;
}

public HutongGames.PlayMaker.FsmString trueString
{
get => orig.trueString;
