...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of NexusPlayerRemoteAndroidUnityProfile allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class NexusPlayerRemoteAndroidUnityProfileR:InstanceClassWrapper<InControl.UnityDeviceProfiles.NexusPlayerRemoteAndroidUnityProfile>
{
public NexusPlayerRemoteAndroidUnityProfileR(InControl.UnityDeviceProfiles.NexusPlayerRemoteAndroidUnityProfile _orig) : base(_orig) {}
