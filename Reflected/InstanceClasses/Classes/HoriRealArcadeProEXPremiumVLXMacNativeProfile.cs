...
/// <summary>
///     A class that contains all (public and private) fields and methods of HoriRealArcadeProEXPremiumVLXMacNativeProfile
///     allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class
    HoriRealArcadeProEXPremiumVLXMacNativeProfileR : InstanceClassWrapper<HoriRealArcadeProEXPremiumVLXMacNativeProfile>
{
    public HoriRealArcadeProEXPremiumVLXMacNativeProfileR(HoriRealArcadeProEXPremiumVLXMacNativeProfile _orig) :
        base(_orig)
    {
    }
