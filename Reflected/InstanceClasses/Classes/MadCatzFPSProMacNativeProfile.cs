...
/// </summary>
public class MadCatzFPSProMacNativeProfileR : InstanceClassWrapper<MadCatzFPSProMacNativeProfile>
{
    public MadCatzFPSProMacNativeProfileR(MadCatzFPSProMacNativeProfile _orig) : base(_orig)
    {
    }
