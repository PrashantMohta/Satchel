...
/// </summary>
public class LogitechF710LinuxUnityProfileR : InstanceClassWrapper<LogitechF710LinuxUnityProfile>
{
    public LogitechF710LinuxUnityProfileR(LogitechF710LinuxUnityProfile _orig) : base(_orig)
    {
    }
