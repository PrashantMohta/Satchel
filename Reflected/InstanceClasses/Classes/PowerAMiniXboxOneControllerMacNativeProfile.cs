...
/// <summary>
///     A class that contains all (public and private) fields and methods of PowerAMiniXboxOneControllerMacNativeProfile
///     allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class
    PowerAMiniXboxOneControllerMacNativeProfileR : InstanceClassWrapper<PowerAMiniXboxOneControllerMacNativeProfile>
{
    public PowerAMiniXboxOneControllerMacNativeProfileR(PowerAMiniXboxOneControllerMacNativeProfile _orig) : base(_orig)
    {
    }
