...
/// </summary>
public class OuyaEverywhereDeviceR:InstanceClassWrapper<InControl.OuyaEverywhereDevice>
{
public OuyaEverywhereDeviceR(InControl.OuyaEverywhereDevice _orig) : base(_orig) {}
