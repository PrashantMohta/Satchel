...
/// </summary>
public class GetFsmArrayR:InstanceClassWrapper<HutongGames.PlayMaker.Actions.GetFsmArray>
{
public GetFsmArrayR(HutongGames.PlayMaker.Actions.GetFsmArray _orig) : base(_orig) {}
...
public HutongGames.PlayMaker.FsmArray storeValue
{
get => orig.storeValue;
