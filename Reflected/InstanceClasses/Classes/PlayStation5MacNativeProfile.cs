...
/// </summary>
public class PlayStation5MacNativeProfileR : InstanceClassWrapper<PlayStation5MacNativeProfile>
{
    public PlayStation5MacNativeProfileR(PlayStation5MacNativeProfile _orig) : base(_orig)
    {
    }
