...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of SpawnFromPoolV2 allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class SpawnFromPoolV2R:InstanceClassWrapper<HutongGames.PlayMaker.Actions.SpawnFromPoolV2>
{
public SpawnFromPoolV2R(HutongGames.PlayMaker.Actions.SpawnFromPoolV2 _orig) : base(_orig) {}
...
public HutongGames.PlayMaker.FsmVector3 setPosition
{
get => orig.setPosition;
set => orig.setPosition = value;
}
...
public HutongGames.PlayMaker.FsmString FSM
{
get => orig.FSM;
set => orig.FSM = value;
}

public HutongGames.PlayMaker.FsmString FSMEvent
{
get => orig.FSMEvent;
