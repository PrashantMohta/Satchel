...
/// </summary>
public class GenericAndroidUnityProfileR : InstanceClassWrapper<GenericAndroidUnityProfile>
{
    public GenericAndroidUnityProfileR(GenericAndroidUnityProfile _orig) : base(_orig)
    {
    }
