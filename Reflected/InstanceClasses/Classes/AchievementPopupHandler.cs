...
public System.Collections.Generic.List<AchievementPopup> popups
{
get => GetField<System.Collections.Generic.List<AchievementPopup>>();
set => SetField(value);
}
