...
/// </summary>
public class BuffaloClassicMacNativeProfileR : InstanceClassWrapper<BuffaloClassicMacNativeProfile>
{
    public BuffaloClassicMacNativeProfileR(BuffaloClassicMacNativeProfile _orig) : base(_orig)
    {
    }
