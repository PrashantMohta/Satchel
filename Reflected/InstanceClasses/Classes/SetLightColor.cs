...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of SetLightColor allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class SetLightColorR:InstanceClassWrapper<HutongGames.PlayMaker.Actions.SetLightColor>
{
public SetLightColorR(HutongGames.PlayMaker.Actions.SetLightColor _orig) : base(_orig) {}
...
public HutongGames.PlayMaker.FsmColor lightColor
{
get => orig.lightColor;
set => orig.lightColor = value;
}
