...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of RockCandyControllerMacNativeProfile allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class RockCandyControllerMacNativeProfileR:InstanceClassWrapper<InControl.NativeDeviceProfiles.RockCandyControllerMacNativeProfile>
{
public RockCandyControllerMacNativeProfileR(InControl.NativeDeviceProfiles.RockCandyControllerMacNativeProfile _orig) : base(_orig) {}
