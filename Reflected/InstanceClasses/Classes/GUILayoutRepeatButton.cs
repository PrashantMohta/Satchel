...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of GUILayoutRepeatButton allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class GUILayoutRepeatButtonR:InstanceClassWrapper<HutongGames.PlayMaker.Actions.GUILayoutRepeatButton>
{
public GUILayoutRepeatButtonR(HutongGames.PlayMaker.Actions.GUILayoutRepeatButton _orig) : base(_orig) {}
