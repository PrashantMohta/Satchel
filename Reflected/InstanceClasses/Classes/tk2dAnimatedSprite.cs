...
{
get => tk2dAnimatedSprite.DefaultFps;
}
...
public tk2dAnimatedSprite AddComponent (UnityEngine.GameObject go, tk2dSpriteAnimation anim, int clipId) =>
tk2dAnimatedSprite.AddComponent(go, anim, clipId);
