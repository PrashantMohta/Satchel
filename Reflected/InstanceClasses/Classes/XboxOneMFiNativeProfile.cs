...
/// </summary>
public class XboxOneMFiNativeProfileR : InstanceClassWrapper<XboxOneMFiNativeProfile>
{
    public XboxOneMFiNativeProfileR(XboxOneMFiNativeProfile _orig) : base(_orig)
    {
    }
