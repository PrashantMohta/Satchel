...
/// </summary>
public class StopAnimationR:InstanceClassWrapper<HutongGames.PlayMaker.Actions.StopAnimation>
{
public StopAnimationR(HutongGames.PlayMaker.Actions.StopAnimation _orig) : base(_orig) {}
