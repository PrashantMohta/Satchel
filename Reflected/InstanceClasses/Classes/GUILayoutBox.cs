...
/// </summary>
public class GUILayoutBoxR:InstanceClassWrapper<HutongGames.PlayMaker.Actions.GUILayoutBox>
{
public GUILayoutBoxR(HutongGames.PlayMaker.Actions.GUILayoutBox _orig) : base(_orig) {}
