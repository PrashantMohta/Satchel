...
/// </summary>
public class SwitchSimpleInputDeviceR : InstanceClassWrapper<SwitchSimpleInputDevice>
{
    public SwitchSimpleInputDeviceR(SwitchSimpleInputDevice _orig) : base(_orig)
    {
    }
