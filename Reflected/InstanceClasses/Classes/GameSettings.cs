...
public System.String[] commArgs
{
get => GetField<System.String[]>();
set => SetField(value);
}

public GlobalEnums.SupportedLanguages gameLanguage
{
...
public void LoadAndUpgradeKeyboardKey (string prefsKey, string setString, InControl.Key defaultKey) =>
CallMethod(new object[] {prefsKey, setString, defaultKey});

public void SaveKeyboardSettings () =>
orig.SaveKeyboardSettings();

public bool LoadGamepadSettings (GlobalEnums.GamepadType gamepadType) =>
orig.LoadGamepadSettings(gamepadType);

public void SaveGamepadSettings (GlobalEnums.GamepadType gamepadType) =>
orig.SaveGamepadSettings(gamepadType);

public void ResetGamepadSettings (GlobalEnums.GamepadType gamepadType) =>
orig.ResetGamepadSettings(gamepadType);

public GlobalEnums.GamepadType RemapGamepadTypeForSettings (GlobalEnums.GamepadType sourceType) =>
CallMethod<GlobalEnums.GamepadType>(new object[] {sourceType});

public bool LoadInt (string key, int val, int def) =>
CallMethod<bool>(new object[] {key, val, def});
