...
/// </summary>
public class IpegaPG9023AndroidUnityProfileR : InstanceClassWrapper<IpegaPG9023AndroidUnityProfile>
{
    public IpegaPG9023AndroidUnityProfileR(IpegaPG9023AndroidUnityProfile _orig) : base(_orig)
    {
    }
