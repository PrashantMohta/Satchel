...
/// </summary>
public class RedSamuraiAndroidUnityProfileR : InstanceClassWrapper<RedSamuraiAndroidUnityProfile>
{
    public RedSamuraiAndroidUnityProfileR(RedSamuraiAndroidUnityProfile _orig) : base(_orig)
    {
    }
