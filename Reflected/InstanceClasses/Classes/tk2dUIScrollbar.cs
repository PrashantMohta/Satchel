...
public class tk2dUIScrollbarR : InstanceClassWrapper<tk2dUIScrollbar>
{
    ...
    public Vector3 moveThumbBtnOffset
    {
    ...
    public Action<tk2dUIScrollbar> OnScroll
    {
        get => GetField<Action<tk2dUIScrollbar>>();
        set => SetField(value);
    }
    ...
    public void ScrollToPosition(Vector3 worldPos)
    {
