...
/// </summary>
public class XTR55_G2_MacNativeProfileR : InstanceClassWrapper<XTR55_G2_MacNativeProfile>
{
    public XTR55_G2_MacNativeProfileR(XTR55_G2_MacNativeProfile _orig) : base(_orig)
    {
    }
