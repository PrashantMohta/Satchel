...
/// </summary>
public class SetAnimationWeightR : InstanceClassWrapper<SetAnimationWeight>
{
    public SetAnimationWeightR(SetAnimationWeight _orig) : base(_orig)
    {
    }
    ...
    public void DoSetAnimationWeight(GameObject go)
    {
