...
/// </summary>
public class WaitRandomR:InstanceClassWrapper<HutongGames.PlayMaker.Actions.WaitRandom>
{
public WaitRandomR(HutongGames.PlayMaker.Actions.WaitRandom _orig) : base(_orig) {}
public HutongGames.PlayMaker.FsmFloat timeMin
{
get => orig.timeMin;
set => orig.timeMin = value;
}

public HutongGames.PlayMaker.FsmFloat timeMax
{
get => orig.timeMax;
