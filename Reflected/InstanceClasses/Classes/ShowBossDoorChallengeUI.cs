...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of ShowBossDoorChallengeUI allowing you to
...
public HutongGames.PlayMaker.FsmOwnerDefault targetDoor
{
get => orig.targetDoor;
...
public HutongGames.PlayMaker.FsmEvent cancelEvent
{
get => orig.cancelEvent;
set => orig.cancelEvent = value;
}

public HutongGames.PlayMaker.FsmEvent challengeEvent
{
