...
/// </summary>
public class GameCubeWindowsUnityProfileR : InstanceClassWrapper<GameCubeWindowsUnityProfile>
{
    public GameCubeWindowsUnityProfileR(GameCubeWindowsUnityProfile _orig) : base(_orig)
    {
    }
