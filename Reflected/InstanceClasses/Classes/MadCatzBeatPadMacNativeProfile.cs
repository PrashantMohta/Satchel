...
/// </summary>
public class MadCatzBeatPadMacNativeProfileR : InstanceClassWrapper<MadCatzBeatPadMacNativeProfile>
{
    public MadCatzBeatPadMacNativeProfileR(MadCatzBeatPadMacNativeProfile _orig) : base(_orig)
    {
    }
