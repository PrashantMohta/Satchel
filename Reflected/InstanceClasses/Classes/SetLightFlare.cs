...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of SetLightFlare allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class SetLightFlareR:InstanceClassWrapper<HutongGames.PlayMaker.Actions.SetLightFlare>
{
public SetLightFlareR(HutongGames.PlayMaker.Actions.SetLightFlare _orig) : base(_orig) {}
...
public UnityEngine.Flare lightFlare
{
get => orig.lightFlare;
set => orig.lightFlare = value;
}
