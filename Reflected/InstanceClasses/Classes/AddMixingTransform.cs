...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of AddMixingTransform allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class AddMixingTransformR:InstanceClassWrapper<HutongGames.PlayMaker.Actions.AddMixingTransform>
{
public AddMixingTransformR(HutongGames.PlayMaker.Actions.AddMixingTransform _orig) : base(_orig) {}
...
public HutongGames.PlayMaker.FsmString transform
{
get => orig.transform;
set => orig.transform = value;
}
...
public void DoAddMixingTransform () =>
CallMethod();
