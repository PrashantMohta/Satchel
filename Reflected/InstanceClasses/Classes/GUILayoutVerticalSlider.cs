...
/// </summary>
public class GUILayoutVerticalSliderR : InstanceClassWrapper<GUILayoutVerticalSlider>
{
    public GUILayoutVerticalSliderR(GUILayoutVerticalSlider _orig) : base(_orig)
    {
    }
