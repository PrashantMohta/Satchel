...
/// </summary>
public class PlayStation4MacUSBUnityProfileR : InstanceClassWrapper<PlayStation4MacUSBUnityProfile>
{
    public PlayStation4MacUSBUnityProfileR(PlayStation4MacUSBUnityProfile _orig) : base(_orig)
    {
    }
