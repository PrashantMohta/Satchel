...
/// </summary>
public class IpegaPG9068AndroidUnityProfileR : InstanceClassWrapper<IpegaPG9068AndroidUnityProfile>
{
    public IpegaPG9068AndroidUnityProfileR(IpegaPG9068AndroidUnityProfile _orig) : base(_orig)
    {
    }
