...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of iTweenFadeTo allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class iTweenFadeToR:InstanceClassWrapper<HutongGames.PlayMaker.Actions.iTweenFadeTo>
{
public iTweenFadeToR(HutongGames.PlayMaker.Actions.iTweenFadeTo _orig) : base(_orig) {}
...
public HutongGames.PlayMaker.FsmBool includeChildren
{
get => orig.includeChildren;
set => orig.includeChildren = value;
}

public HutongGames.PlayMaker.FsmString namedValueColor
{
get => orig.namedValueColor;
set => orig.namedValueColor = value;
}
