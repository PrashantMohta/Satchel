...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of FlingObject allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class FlingObjectR:InstanceClassWrapper<HutongGames.PlayMaker.Actions.FlingObject>
{
public FlingObjectR(HutongGames.PlayMaker.Actions.FlingObject _orig) : base(_orig) {}
public HutongGames.PlayMaker.FsmOwnerDefault flungObject
{
get => orig.flungObject;
set => orig.flungObject = value;
}
