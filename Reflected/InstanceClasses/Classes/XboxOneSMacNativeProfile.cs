...
/// </summary>
public class XboxOneSMacNativeProfileR : InstanceClassWrapper<XboxOneSMacNativeProfile>
{
    public XboxOneSMacNativeProfileR(XboxOneSMacNativeProfile _orig) : base(_orig)
    {
    }
