...
/// </summary>
public class SpeedlinkStrikeMacUnityProfileR : InstanceClassWrapper<SpeedlinkStrikeMacUnityProfile>
{
    public SpeedlinkStrikeMacUnityProfileR(SpeedlinkStrikeMacUnityProfile _orig) : base(_orig)
    {
    }
