...
/// </summary>
public class Xbox360MacChromeUnityProfileR : InstanceClassWrapper<Xbox360MacChromeUnityProfile>
{
    public Xbox360MacChromeUnityProfileR(Xbox360MacChromeUnityProfile _orig) : base(_orig)
    {
    }
