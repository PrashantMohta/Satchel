...
/// </summary>
public class SteelSeriesFreeMacUnityProfileR : InstanceClassWrapper<SteelSeriesFreeMacUnityProfile>
{
    public SteelSeriesFreeMacUnityProfileR(SteelSeriesFreeMacUnityProfile _orig) : base(_orig)
    {
    }
