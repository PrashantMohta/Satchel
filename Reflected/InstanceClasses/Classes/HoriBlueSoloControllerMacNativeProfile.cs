...
/// <summary>
///     A class that contains all (public and private) fields and methods of HoriBlueSoloControllerMacNativeProfile
///     allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class HoriBlueSoloControllerMacNativeProfileR : InstanceClassWrapper<HoriBlueSoloControllerMacNativeProfile>
{
    public HoriBlueSoloControllerMacNativeProfileR(HoriBlueSoloControllerMacNativeProfile _orig) : base(_orig)
    {
    }
