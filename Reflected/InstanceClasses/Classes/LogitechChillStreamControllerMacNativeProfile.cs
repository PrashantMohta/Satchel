...
/// <summary>
///     A class that contains all (public and private) fields and methods of LogitechChillStreamControllerMacNativeProfile
///     allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class
    LogitechChillStreamControllerMacNativeProfileR : InstanceClassWrapper<LogitechChillStreamControllerMacNativeProfile>
{
    public LogitechChillStreamControllerMacNativeProfileR(LogitechChillStreamControllerMacNativeProfile _orig) :
        base(_orig)
    {
    }
