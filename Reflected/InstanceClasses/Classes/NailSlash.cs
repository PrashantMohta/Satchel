...
public UnityEngine.PolygonCollider2D poly
{
get => GetField<UnityEngine.PolygonCollider2D>();
set => SetField(value);
}
...
public UnityEngine.PolygonCollider2D clashTinkPoly
{
get => GetField<UnityEngine.PolygonCollider2D>();
set => SetField(value);
}
...
public void Bounce (UnityEngine.Collider2D otherCollider, bool useEffects) =>
...
public void orig_OnTriggerEnter2D (UnityEngine.Collider2D otherCollider) =>
CallMethod(new object[] {otherCollider});
