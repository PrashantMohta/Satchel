...
/// </summary>
public class GenericBlackBerryUnityProfileR : InstanceClassWrapper<GenericBlackBerryUnityProfile>
{
    public GenericBlackBerryUnityProfileR(GenericBlackBerryUnityProfile _orig) : base(_orig)
    {
    }
