...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of RazerServalMacUnityProfile allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class RazerServalMacUnityProfileR:InstanceClassWrapper<InControl.UnityDeviceProfiles.RazerServalMacUnityProfile>
{
public RazerServalMacUnityProfileR(InControl.UnityDeviceProfiles.RazerServalMacUnityProfile _orig) : base(_orig) {}
