...
/// </summary>
public class RazerServalMacUnityProfileR : InstanceClassWrapper<RazerServalMacUnityProfile>
{
    public RazerServalMacUnityProfileR(RazerServalMacUnityProfile _orig) : base(_orig)
    {
    }
