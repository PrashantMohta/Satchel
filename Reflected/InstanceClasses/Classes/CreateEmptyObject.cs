...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of CreateEmptyObject allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class CreateEmptyObjectR:InstanceClassWrapper<HutongGames.PlayMaker.Actions.CreateEmptyObject>
{
public CreateEmptyObjectR(HutongGames.PlayMaker.Actions.CreateEmptyObject _orig) : base(_orig) {}
