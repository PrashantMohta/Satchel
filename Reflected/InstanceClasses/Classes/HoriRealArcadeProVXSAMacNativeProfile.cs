...
/// <summary>
///     A class that contains all (public and private) fields and methods of HoriRealArcadeProVXSAMacNativeProfile allowing
///     you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class HoriRealArcadeProVXSAMacNativeProfileR : InstanceClassWrapper<HoriRealArcadeProVXSAMacNativeProfile>
{
    public HoriRealArcadeProVXSAMacNativeProfileR(HoriRealArcadeProVXSAMacNativeProfile _orig) : base(_orig)
    {
    }
