...
/// <summary>
///     A class that contains all (public and private) fields and methods of
///     ThrustMasterFerrari458SpiderRacingWheelMacNativeProfile allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class
    ThrustMasterFerrari458SpiderRacingWheelMacNativeProfileR : InstanceClassWrapper<
        ThrustMasterFerrari458SpiderRacingWheelMacNativeProfile>
{
    public ThrustMasterFerrari458SpiderRacingWheelMacNativeProfileR(
        ThrustMasterFerrari458SpiderRacingWheelMacNativeProfile _orig) : base(_orig)
    {
    }
