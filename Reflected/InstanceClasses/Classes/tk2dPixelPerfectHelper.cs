...
public tk2dPixelPerfectHelper inst
{
get => tk2dPixelPerfectHelper.inst;
}

public bool CameraIsOrtho
{
get => orig.CameraIsOrtho;
}
...
tk2dPixelPerfectHelper.CalculateScaleForPerspectiveCamera(fov, zdist);
