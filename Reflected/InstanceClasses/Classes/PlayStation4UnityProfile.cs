...
/// </summary>
public class PlayStation4UnityProfileR : InstanceClassWrapper<PlayStation4UnityProfile>
{
    public PlayStation4UnityProfileR(PlayStation4UnityProfile _orig) : base(_orig)
    {
    }
