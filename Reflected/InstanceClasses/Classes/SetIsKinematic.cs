...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of SetIsKinematic allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class SetIsKinematicR:InstanceClassWrapper<HutongGames.PlayMaker.Actions.SetIsKinematic>
{
public SetIsKinematicR(HutongGames.PlayMaker.Actions.SetIsKinematic _orig) : base(_orig) {}
