...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of ListenForBackdash allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class ListenForBackdashR:InstanceClassWrapper<HutongGames.PlayMaker.Actions.ListenForBackdash>
{
public ListenForBackdashR(HutongGames.PlayMaker.Actions.ListenForBackdash _orig) : base(_orig) {}
