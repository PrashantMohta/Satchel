...
/// </summary>
public class CheckCollisionSideEnterR : InstanceClassWrapper<CheckCollisionSideEnter>
{
    public CheckCollisionSideEnterR(CheckCollisionSideEnter _orig) : base(_orig)
    {
    }
    ...
    public void DoCollisionEnter2D(Collision2D collision)
    {
