...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of CheckCollisionSideEnter allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class CheckCollisionSideEnterR:InstanceClassWrapper<HutongGames.PlayMaker.Actions.CheckCollisionSideEnter>
{
public CheckCollisionSideEnterR(HutongGames.PlayMaker.Actions.CheckCollisionSideEnter _orig) : base(_orig) {}
...
public void DoCollisionEnter2D (UnityEngine.Collision2D collision) =>
orig.DoCollisionEnter2D(collision);
