...
/// </summary>
public class PlayStation3MacNativeProfileR : InstanceClassWrapper<PlayStation3MacNativeProfile>
{
    public PlayStation3MacNativeProfileR(PlayStation3MacNativeProfile _orig) : base(_orig)
    {
    }
