...
/// <summary>
///     A class that contains all (public and private) fields and methods of SteelSeriesFreeWindowsUnityProfile allowing
///     you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class SteelSeriesFreeWindowsUnityProfileR : InstanceClassWrapper<SteelSeriesFreeWindowsUnityProfile>
{
    public SteelSeriesFreeWindowsUnityProfileR(SteelSeriesFreeWindowsUnityProfile _orig) : base(_orig)
    {
    }
