...
/// <summary>
///     A class that contains all (public and private) fields and methods of RazerServalWindowsNativeProfile allowing you
///     to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class RazerServalWindowsNativeProfileR : InstanceClassWrapper<RazerServalWindowsNativeProfile>
{
    public RazerServalWindowsNativeProfileR(RazerServalWindowsNativeProfile _orig) : base(_orig)
    {
    }
