...
/// </summary>
public class Tk2dTextMeshSetPixelPerfectR : InstanceClassWrapper<Tk2dTextMeshSetPixelPerfect>
{
    public Tk2dTextMeshSetPixelPerfectR(Tk2dTextMeshSetPixelPerfect _orig) : base(_orig)
    {
    }
