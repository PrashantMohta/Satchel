...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of HoneyBeeControllerMacNativeProfile allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class HoneyBeeControllerMacNativeProfileR:InstanceClassWrapper<InControl.NativeDeviceProfiles.HoneyBeeControllerMacNativeProfile>
{
public HoneyBeeControllerMacNativeProfileR(InControl.NativeDeviceProfiles.HoneyBeeControllerMacNativeProfile _orig) : base(_orig) {}
