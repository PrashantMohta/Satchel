...
/// </summary>
public class OuyaAmazonUnityProfileR : InstanceClassWrapper<OuyaAmazonUnityProfile>
{
    public OuyaAmazonUnityProfileR(OuyaAmazonUnityProfile _orig) : base(_orig)
    {
    }
