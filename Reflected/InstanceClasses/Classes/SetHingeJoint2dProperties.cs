...
/// </summary>
public class SetHingeJoint2dPropertiesR : InstanceClassWrapper<SetHingeJoint2dProperties>
{
    public SetHingeJoint2dPropertiesR(SetHingeJoint2dProperties _orig) : base(_orig)
    {
    }
    ...
    public JointAngleLimits2D _limits
    {
        get => GetField<JointAngleLimits2D>();
        set => SetField(value);
    }
