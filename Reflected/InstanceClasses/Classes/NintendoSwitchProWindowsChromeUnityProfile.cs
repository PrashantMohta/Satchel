...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of NintendoSwitchProWindowsChromeUnityProfile allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class NintendoSwitchProWindowsChromeUnityProfileR:InstanceClassWrapper<InControl.UnityDeviceProfiles.NintendoSwitchProWindowsChromeUnityProfile>
{
public NintendoSwitchProWindowsChromeUnityProfileR(InControl.UnityDeviceProfiles.NintendoSwitchProWindowsChromeUnityProfile _orig) : base(_orig) {}
