...
/// </summary>
public class BTC938AndroidUnityProfileR : InstanceClassWrapper<BTC938AndroidUnityProfile>
{
    public BTC938AndroidUnityProfileR(BTC938AndroidUnityProfile _orig) : base(_orig)
    {
    }
