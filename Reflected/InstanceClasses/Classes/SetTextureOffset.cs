...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of SetTextureOffset allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class SetTextureOffsetR:InstanceClassWrapper<HutongGames.PlayMaker.Actions.SetTextureOffset>
{
public SetTextureOffsetR(HutongGames.PlayMaker.Actions.SetTextureOffset _orig) : base(_orig) {}
...
public void DoSetTextureOffset () =>
CallMethod();
