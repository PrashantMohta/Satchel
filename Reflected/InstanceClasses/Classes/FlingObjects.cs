...
/// </summary>
public class FlingObjectsR:InstanceClassWrapper<HutongGames.PlayMaker.Actions.FlingObjects>
{
public FlingObjectsR(HutongGames.PlayMaker.Actions.FlingObjects _orig) : base(_orig) {}
public HutongGames.PlayMaker.FsmGameObject containerObject
{
...
public HutongGames.PlayMaker.FsmBool randomisePosition
{
