...
/// </summary>
public class MogaProLinuxUnityProfileR : InstanceClassWrapper<MogaProLinuxUnityProfile>
{
    public MogaProLinuxUnityProfileR(MogaProLinuxUnityProfile _orig) : base(_orig)
    {
    }
