...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of ListenForRight allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class ListenForRightR:InstanceClassWrapper<HutongGames.PlayMaker.Actions.ListenForRight>
{
public ListenForRightR(HutongGames.PlayMaker.Actions.ListenForRight _orig) : base(_orig) {}
