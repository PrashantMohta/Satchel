...
/// </summary>
public class TextMeshProUGUIR : InstanceClassWrapper<TextMeshProUGUI>
{
    public TextMeshProUGUIR(TextMeshProUGUI _orig) : base(_orig)
    {
    }
    ...
    public InlineGraphicManager inlineGraphicManager => orig.inlineGraphicManager;
