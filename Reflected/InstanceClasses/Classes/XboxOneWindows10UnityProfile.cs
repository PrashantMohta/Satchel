...
/// </summary>
public class XboxOneWindows10UnityProfileR : InstanceClassWrapper<XboxOneWindows10UnityProfile>
{
    public XboxOneWindows10UnityProfileR(XboxOneWindows10UnityProfile _orig) : base(_orig)
    {
    }
