...
/// </summary>
public class SpawnRandomObjectsVelocityR : InstanceClassWrapper<SpawnRandomObjectsVelocity>
{
    public SpawnRandomObjectsVelocityR(SpawnRandomObjectsVelocity _orig) : base(_orig)
    {
    }
