...
/// </summary>
public class EightBitdoSFC30MacUnityProfileR : InstanceClassWrapper<EightBitdoSFC30MacUnityProfile>
{
    public EightBitdoSFC30MacUnityProfileR(EightBitdoSFC30MacUnityProfile _orig) : base(_orig)
    {
    }
