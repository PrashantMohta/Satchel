...
/// </summary>
public class IpegaPG9025AndroidUnityProfileR : InstanceClassWrapper<IpegaPG9025AndroidUnityProfile>
{
    public IpegaPG9025AndroidUnityProfileR(IpegaPG9025AndroidUnityProfile _orig) : base(_orig)
    {
    }
