...
/// </summary>
public class DroidBoxPS3AndroidUnityProfileR : InstanceClassWrapper<DroidBoxPS3AndroidUnityProfile>
{
    public DroidBoxPS3AndroidUnityProfileR(DroidBoxPS3AndroidUnityProfile _orig) : base(_orig)
    {
    }
