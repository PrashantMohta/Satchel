...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of uGuiGetColorBlock allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class uGuiGetColorBlockR:InstanceClassWrapper<HutongGames.PlayMaker.Actions.uGuiGetColorBlock>
{
public uGuiGetColorBlockR(HutongGames.PlayMaker.Actions.uGuiGetColorBlock _orig) : base(_orig) {}
