...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of SetRandomMaterial allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class SetRandomMaterialR:InstanceClassWrapper<HutongGames.PlayMaker.Actions.SetRandomMaterial>
{
public SetRandomMaterialR(HutongGames.PlayMaker.Actions.SetRandomMaterial _orig) : base(_orig) {}
...
public HutongGames.PlayMaker.FsmMaterial[] materials
{
get => orig.materials;
...
public void DoSetRandomMaterial () =>
CallMethod();
