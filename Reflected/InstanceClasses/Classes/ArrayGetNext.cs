...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of ArrayGetNext allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class ArrayGetNextR:InstanceClassWrapper<HutongGames.PlayMaker.Actions.ArrayGetNext>
{
public ArrayGetNextR(HutongGames.PlayMaker.Actions.ArrayGetNext _orig) : base(_orig) {}
