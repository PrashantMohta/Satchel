...
/// </summary>
public class ArrayListGetNearestFloatValueR : InstanceClassWrapper<ArrayListGetNearestFloatValue>
{
    public ArrayListGetNearestFloatValueR(ArrayListGetNearestFloatValue _orig) : base(_orig)
    {
    }
