...
/// </summary>
public class AndroidTVAmazonUnityProfileR : InstanceClassWrapper<AndroidTVAmazonUnityProfile>
{
    public AndroidTVAmazonUnityProfileR(AndroidTVAmazonUnityProfile _orig) : base(_orig)
    {
    }
