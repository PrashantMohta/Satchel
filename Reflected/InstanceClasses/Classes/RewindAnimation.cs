...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of RewindAnimation allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class RewindAnimationR:InstanceClassWrapper<HutongGames.PlayMaker.Actions.RewindAnimation>
{
public RewindAnimationR(HutongGames.PlayMaker.Actions.RewindAnimation _orig) : base(_orig) {}
