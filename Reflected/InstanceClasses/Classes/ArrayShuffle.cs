...
/// </summary>
public class ArrayShuffleR:InstanceClassWrapper<HutongGames.PlayMaker.Actions.ArrayShuffle>
{
public ArrayShuffleR(HutongGames.PlayMaker.Actions.ArrayShuffle _orig) : base(_orig) {}
