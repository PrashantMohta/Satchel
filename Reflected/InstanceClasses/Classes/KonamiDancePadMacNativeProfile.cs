...
/// </summary>
public class KonamiDancePadMacNativeProfileR : InstanceClassWrapper<KonamiDancePadMacNativeProfile>
{
    public KonamiDancePadMacNativeProfileR(KonamiDancePadMacNativeProfile _orig) : base(_orig)
    {
    }
