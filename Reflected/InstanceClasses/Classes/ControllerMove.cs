...
/// </summary>
public class ControllerMoveR:InstanceClassWrapper<HutongGames.PlayMaker.Actions.ControllerMove>
{
public ControllerMoveR(HutongGames.PlayMaker.Actions.ControllerMove _orig) : base(_orig) {}
...
public HutongGames.PlayMaker.FsmBool perSecond
{
get => orig.perSecond;
