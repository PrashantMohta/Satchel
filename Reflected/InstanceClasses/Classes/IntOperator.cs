...
/// </summary>
public class IntOperatorR:InstanceClassWrapper<HutongGames.PlayMaker.Actions.IntOperator>
{
public IntOperatorR(HutongGames.PlayMaker.Actions.IntOperator _orig) : base(_orig) {}
