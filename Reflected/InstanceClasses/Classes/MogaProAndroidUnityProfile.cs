...
/// </summary>
public class MogaProAndroidUnityProfileR : InstanceClassWrapper<MogaProAndroidUnityProfile>
{
    public MogaProAndroidUnityProfileR(MogaProAndroidUnityProfile _orig) : base(_orig)
    {
    }
