...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of MaxFireBlaze5WindowsUnityProfile allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class MaxFireBlaze5WindowsUnityProfileR:InstanceClassWrapper<InControl.UnityDeviceProfiles.MaxFireBlaze5WindowsUnityProfile>
{
public MaxFireBlaze5WindowsUnityProfileR(InControl.UnityDeviceProfiles.MaxFireBlaze5WindowsUnityProfile _orig) : base(_orig) {}
