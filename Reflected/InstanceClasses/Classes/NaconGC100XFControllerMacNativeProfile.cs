...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of NaconGC100XFControllerMacNativeProfile allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class NaconGC100XFControllerMacNativeProfileR:InstanceClassWrapper<InControl.NativeDeviceProfiles.NaconGC100XFControllerMacNativeProfile>
{
public NaconGC100XFControllerMacNativeProfileR(InControl.NativeDeviceProfiles.NaconGC100XFControllerMacNativeProfile _orig) : base(_orig) {}
