...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of EightBitdoSFC30WindowsUnityProfile allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class EightBitdoSFC30WindowsUnityProfileR:InstanceClassWrapper<InControl.UnityDeviceProfiles.EightBitdoSFC30WindowsUnityProfile>
{
public EightBitdoSFC30WindowsUnityProfileR(InControl.UnityDeviceProfiles.EightBitdoSFC30WindowsUnityProfile _orig) : base(_orig) {}
