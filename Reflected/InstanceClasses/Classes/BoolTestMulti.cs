...
/// </summary>
public class BoolTestMultiR:InstanceClassWrapper<HutongGames.PlayMaker.Actions.BoolTestMulti>
{
public BoolTestMultiR(HutongGames.PlayMaker.Actions.BoolTestMulti _orig) : base(_orig) {}
...
public HutongGames.PlayMaker.FsmBool[] boolStates
{
get => orig.boolStates;
