...
/// </summary>
public class Vector3InvertR:InstanceClassWrapper<HutongGames.PlayMaker.Actions.Vector3Invert>
{
public Vector3InvertR(HutongGames.PlayMaker.Actions.Vector3Invert _orig) : base(_orig) {}
