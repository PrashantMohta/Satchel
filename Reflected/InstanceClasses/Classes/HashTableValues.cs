...
/// </summary>
public class HashTableValuesR:InstanceClassWrapper<HutongGames.PlayMaker.Actions.HashTableValues>
{
public HashTableValuesR(HutongGames.PlayMaker.Actions.HashTableValues _orig) : base(_orig) {}
