...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of SetShadowStrength allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class SetShadowStrengthR:InstanceClassWrapper<HutongGames.PlayMaker.Actions.SetShadowStrength>
{
public SetShadowStrengthR(HutongGames.PlayMaker.Actions.SetShadowStrength _orig) : base(_orig) {}
...
public HutongGames.PlayMaker.FsmFloat shadowStrength
{
get => orig.shadowStrength;
set => orig.shadowStrength = value;
}
...
public void DoSetShadowStrength () =>
CallMethod();
