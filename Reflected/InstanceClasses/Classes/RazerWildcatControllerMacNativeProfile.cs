...
/// <summary>
///     A class that contains all (public and private) fields and methods of RazerWildcatControllerMacNativeProfile
///     allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class RazerWildcatControllerMacNativeProfileR : InstanceClassWrapper<RazerWildcatControllerMacNativeProfile>
{
    public RazerWildcatControllerMacNativeProfileR(RazerWildcatControllerMacNativeProfile _orig) : base(_orig)
    {
    }
