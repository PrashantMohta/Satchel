...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of GGCheckIfBossSequenceCompleted allowing you to
...
public HutongGames.PlayMaker.FsmEvent completedEvent
{
get => orig.completedEvent;
set => orig.completedEvent = value;
}

public HutongGames.PlayMaker.FsmEvent notCompletedEvent
{
