...
/// </summary>
public class AirFloPS3WindowsNativeProfileR : InstanceClassWrapper<AirFloPS3WindowsNativeProfile>
{
    public AirFloPS3WindowsNativeProfileR(AirFloPS3WindowsNativeProfile _orig) : base(_orig)
    {
    }
