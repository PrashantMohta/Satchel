...
/// </summary>
public class ListenForMenuActionsR:InstanceClassWrapper<HutongGames.PlayMaker.Actions.ListenForMenuActions>
{
public ListenForMenuActionsR(HutongGames.PlayMaker.Actions.ListenForMenuActions _orig) : base(_orig) {}
...
public HutongGames.PlayMaker.FsmEvent submitPressed
{
get => orig.submitPressed;
set => orig.submitPressed = value;
}

public HutongGames.PlayMaker.FsmEvent cancelPressed
{
get => orig.cancelPressed;
set => orig.cancelPressed = value;
}

public HutongGames.PlayMaker.FsmBool ignoreAttack
{
