...
/// </summary>
public class XboxOneWindowsNativeProfileR : InstanceClassWrapper<XboxOneWindowsNativeProfile>
{
    public XboxOneWindowsNativeProfileR(XboxOneWindowsNativeProfile _orig) : base(_orig)
    {
    }
