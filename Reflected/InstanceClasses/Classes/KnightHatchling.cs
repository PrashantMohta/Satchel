...
public UnityEngine.Collider2D terrainCollider
{
get => orig.terrainCollider;
set => orig.terrainCollider = value;
}

public System.Collections.Generic.List<UnityEngine.Collider2D> groundColliders
{
...
public UnityEngine.ParticleSystem dungPt
{
get => orig.dungPt;
set => orig.dungPt = value;
}

public UnityEngine.AudioClip[] loopClips
{
get => orig.loopClips;
set => orig.loopClips = value;
}

public UnityEngine.AudioClip attackChargeClip
{
...
public UnityEngine.GameObject dungExplosionPrefab
{
...
public System.Collections.IEnumerator TeleEnd () =>
CallMethod<System.Collections.IEnumerator>();

public void FsmHitLanded () =>
orig.FsmHitLanded();

public System.Collections.IEnumerator Explode () =>
CallMethod<System.Collections.IEnumerator>();

public void FsmCharmsEnd () =>
orig.FsmCharmsEnd();

public System.Collections.IEnumerator CharmsEnd () =>
CallMethod<System.Collections.IEnumerator>();
...
public System.Collections.IEnumerator WakeUp () =>
CallMethod<System.Collections.IEnumerator>();
...
public System.Collections.IEnumerator DreamGateOut () =>
CallMethod<System.Collections.IEnumerator>();

public void DoFace (bool spriteFacesRight, bool playNewAnimation, string newAnimationClip, bool pauseBetweenTurns, float pauseTime) =>
CallMethod(new object[] {spriteFacesRight, playNewAnimation, newAnimationClip, pauseBetweenTurns, pauseTime});

public void DoChase (UnityEngine.Transform target, float distance, float speedMax, float accelerationForce, float targetRadius, float deceleration, UnityEngine.Vector2 offset) =>
CallMethod(new object[] {target, distance, speedMax, accelerationForce, targetRadius, deceleration, offset});

public void DoBuzz (float waitMin, float waitMax, float speedMax, float accelerationMin, float accelerationMax, UnityEngine.Vector2 roamingRange) =>
CallMethod(new object[] {waitMin, waitMax, speedMax, accelerationMin, accelerationMax, roamingRange});

public void DoChaseSimple (UnityEngine.Transform target, float speedMax, float accelerationForce, float offsetX, float offsetY) =>
