...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of SetMaterialColor allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class SetMaterialColorR:InstanceClassWrapper<HutongGames.PlayMaker.Actions.SetMaterialColor>
{
public SetMaterialColorR(HutongGames.PlayMaker.Actions.SetMaterialColor _orig) : base(_orig) {}
...
public HutongGames.PlayMaker.FsmString namedColor
{
get => orig.namedColor;
set => orig.namedColor = value;
}
...
public int GetNameId (HutongGames.PlayMaker.FsmString fsmStr) =>
CallMethodStatic<int>(new object[] {fsmStr});

public void OnUpdate () =>
orig.OnUpdate();

public void DoSetMaterialColor () =>
CallMethod();
