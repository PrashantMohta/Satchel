...
/// </summary>
public class RockBandGuitarMacNativeProfileR : InstanceClassWrapper<RockBandGuitarMacNativeProfile>
{
    public RockBandGuitarMacNativeProfileR(RockBandGuitarMacNativeProfile _orig) : base(_orig)
    {
    }
