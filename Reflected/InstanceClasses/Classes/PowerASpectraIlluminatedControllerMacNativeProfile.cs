...
///     PowerASpectraIlluminatedControllerMacNativeProfile allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class
    PowerASpectraIlluminatedControllerMacNativeProfileR : InstanceClassWrapper<
        PowerASpectraIlluminatedControllerMacNativeProfile>
{
    public PowerASpectraIlluminatedControllerMacNativeProfileR(PowerASpectraIlluminatedControllerMacNativeProfile _orig)
        : base(_orig)
    {
    }
