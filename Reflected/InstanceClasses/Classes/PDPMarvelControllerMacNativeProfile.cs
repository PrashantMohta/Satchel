...
/// <summary>
///     A class that contains all (public and private) fields and methods of PDPMarvelControllerMacNativeProfile allowing
///     you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class PDPMarvelControllerMacNativeProfileR : InstanceClassWrapper<PDPMarvelControllerMacNativeProfile>
{
    public PDPMarvelControllerMacNativeProfileR(PDPMarvelControllerMacNativeProfile _orig) : base(_orig)
    {
    }
