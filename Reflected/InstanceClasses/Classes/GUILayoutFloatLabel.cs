...
/// </summary>
public class GUILayoutFloatLabelR:InstanceClassWrapper<HutongGames.PlayMaker.Actions.GUILayoutFloatLabel>
{
public GUILayoutFloatLabelR(HutongGames.PlayMaker.Actions.GUILayoutFloatLabel _orig) : base(_orig) {}
