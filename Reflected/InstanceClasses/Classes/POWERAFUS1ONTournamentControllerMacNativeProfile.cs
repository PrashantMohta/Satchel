...
///     POWERAFUS1ONTournamentControllerMacNativeProfile allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class
    POWERAFUS1ONTournamentControllerMacNativeProfileR : InstanceClassWrapper<
        POWERAFUS1ONTournamentControllerMacNativeProfile>
{
    public POWERAFUS1ONTournamentControllerMacNativeProfileR(POWERAFUS1ONTournamentControllerMacNativeProfile _orig) :
        base(_orig)
    {
    }
