...
/// <summary>
///     A class that contains all (public and private) fields and methods of NvidiaShieldRemoteAndroidUnityProfile allowing
///     you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class NvidiaShieldRemoteAndroidUnityProfileR : InstanceClassWrapper<NvidiaShieldRemoteAndroidUnityProfile>
{
    public NvidiaShieldRemoteAndroidUnityProfileR(NvidiaShieldRemoteAndroidUnityProfile _orig) : base(_orig)
    {
    }
