...
/// </summary>
public class RayCast2dR:InstanceClassWrapper<HutongGames.PlayMaker.Actions.RayCast2d>
{
public RayCast2dR(HutongGames.PlayMaker.Actions.RayCast2d _orig) : base(_orig) {}
...
public HutongGames.PlayMaker.FsmFloat storeHitFraction
{
