...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of IsKinematic allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class IsKinematicR:InstanceClassWrapper<HutongGames.PlayMaker.Actions.IsKinematic>
{
public IsKinematicR(HutongGames.PlayMaker.Actions.IsKinematic _orig) : base(_orig) {}
