...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of GetFsmInt allowing you to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class GetFsmIntR:InstanceClassWrapper<HutongGames.PlayMaker.Actions.GetFsmInt>
{
public GetFsmIntR(HutongGames.PlayMaker.Actions.GetFsmInt _orig) : base(_orig) {}
