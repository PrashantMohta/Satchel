...
/// <summary>
///     A class that contains all (public and private) fields and methods of HarmonixDrumKitMacNativeProfile allowing you
///     to
///     easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class HarmonixDrumKitMacNativeProfileR : InstanceClassWrapper<HarmonixDrumKitMacNativeProfile>
{
    public HarmonixDrumKitMacNativeProfileR(HarmonixDrumKitMacNativeProfile _orig) : base(_orig)
    {
    }
