...
/// </summary>
public class ConvertMaterialToObjectR : InstanceClassWrapper<ConvertMaterialToObject>
{
    public ConvertMaterialToObjectR(ConvertMaterialToObject _orig) : base(_orig)
    {
    }
