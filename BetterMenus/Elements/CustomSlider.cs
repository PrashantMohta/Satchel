...
namespace Satchel.BetterMenus
{
    public class CustomSlider : Element //should be renamed to slider probs and probably needs to be remade slider needs to be added to nav graph
    {
        ...
        private Text GetValueLabel(){
            if(valueLabel == null){
                valueLabel = gameObject?.Find("MusicValue")?.GetComponent<Text>();
            }
            return valueLabel;
        }
        ...
        public GameObject SetupSlider(GameObject Parent){
            gameObject = GameObject.Instantiate(CustomSlider.GetSliderPrefab(),Parent.transform);
